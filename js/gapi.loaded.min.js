...
a:{var Oe=_.D.navigator;if(Oe){var pg=Oe.userAgent;if(pg){_.We=pg;break a}}_.We=""}_.pf=function(a){return-1!=_.We.indexOf(a)};_.Te=function(){return _.pf("Trident")||_.pf("MSIE")};
...
var um,Pm,up,Lp,Ap;_.Qp=function(a,c){um||Pm();up||(um(),up=!0);Lp.add(a,c)};Pm=function(){if(_.D.Promise&&_.D.Promise.resolve){var a=_.D.Promise.resolve();um=function(){a.then(Ap)}}else um=function(){_.qk(Ap)}};up=!1;Lp=new LD;Ap=function(){for(var a=null;a=Lp.remove();){try{a.Ip.call(a.scope)}catch(c){tp(c)}xE.put(a)}up=!1};
_.Rp=function(a){a.prototype.then=a.prototype.then;a.prototype.$goog_Thenable=!0};_.Wp=function(a){if(!a)return!1;try{return!!a.$goog_Thenable}catch(c){return!1}};var Xq,bq,er,ju;_.C=function(a,c){this.B=0;this.wc=void 0;this.M=this.G=this.ha=null;this.qa=this.Ka=!1;if(a!=_.gh)try{var f=this;a.call(c,function(a){_.hq(f,2,a)},function(a){_.hq(f,3,a)})}catch(g){_.hq(this,3,g)}};Xq=function(){this.next=this.ha=this.G=this.M=this.B=null;this.qa=!1};Xq.prototype.reset=function(){this.ha=this.G=this.M=this.B=null;this.qa=!1};var Bs=new hD(function(){return new Xq},function(a){a.reset()},100),Dt=function(a,c,f){var g=Bs.get();g.M=a;g.G=c;g.ha=f;return g};
_.C.prototype.then=function(a,c,f){return uq(this,_.vd(a)?a:null,_.vd(c)?c:null,f)};_.Rp(_.C);_.C.prototype.cancel=function(a){0==this.B&&_.Qp(function(){var c=new tq(a);Mq(this,c)},this)};
var Mq=function(a,c){if(0==a.B)if(a.ha){var f=a.ha;if(f.G){for(var g=0,h=null,l=null,n=f.G;n&&(n.qa||(g++,n.B==a&&(h=n),!(h&&1<g)));n=n.next)h||(l=n);h&&(0==f.B&&1==g?Mq(f,c):(l?(g=l,g.next==f.M&&(f.M=g),g.next=g.next.next):ju(f),Wq(f,h,3,c)))}a.ha=null}else _.hq(a,3,c)},lr=function(a,c){a.G||2!=a.B&&3!=a.B||er(a);a.M?a.M.next=c:a.G=c;a.M=c},uq=function(a,c,f,g){var h=Dt(null,null,null);h.B=new _.C(function(a,n){h.M=c?function(f){try{var h=c.call(g,f);a(h)}catch(v){n(v)}}:a;h.G=f?function(c){try{var h=
f.call(g,c);!_.kf(h)&&c instanceof tq?n(c):a(h)}catch(v){n(v)}}:n});h.B.ha=a;lr(a,h);return h.B};_.C.prototype.ye=function(a){this.B=0;_.hq(this,2,a)};_.C.prototype.Kh=function(a){this.B=0;_.hq(this,3,a)};_.hq=function(a,c,f){0==a.B&&(a==f&&(c=3,f=new TypeError("Promise cannot resolve to itself")),a.B=1,_.Vp(f,a.ye,a.Kh,a)||(a.wc=f,a.B=c,a.ha=null,er(a),3!=c||f instanceof tq||wq(a,f)))};
_.Vp=function(a,c,f,g){if(a instanceof _.C)return lr(a,Dt(c||_.gh,f||null,g)),!0;if(_.Wp(a))return a.then(c,f,g),!0;if(_.Vg(a))try{var h=a.then;if(_.vd(h))return bq(a,h,c,f,g),!0}catch(l){return f.call(g,l),!0}return!1};bq=function(a,c,f,g,h){var l=!1,n=function(a){l||(l=!0,f.call(h,a))},q=function(a){l||(l=!0,g.call(h,a))};try{c.call(a,n,q)}catch(t){q(t)}};er=function(a){a.Ka||(a.Ka=!0,_.Qp(a.Ld,a))};ju=function(a){var c=null;a.G&&(c=a.G,a.G=c.next,c.next=null);a.G||(a.M=null);return c};
_.C.prototype.Ld=function(){for(var a=null;a=ju(this);)Wq(this,a,this.B,this.wc);this.Ka=!1};var Wq=function(a,c,f,g){if(3==f&&c.G&&!c.qa)for(;a&&a.qa;a=a.ha)a.qa=!1;if(c.B)c.B.ha=null,xs(c,f,g);else try{c.qa?c.M.call(c.ha):xs(c,f,g)}catch(h){nr.call(null,h)}Bs.put(c)},xs=function(a,c,f){2==c?a.M.call(a.ha,f):a.G&&a.G.call(a.ha,f)},wq=function(a,c){a.qa=!0;_.Qp(function(){a.qa&&nr.call(null,c)})},nr=tp,tq=function(a){_.se.call(this,a)};_.J(tq,_.se);tq.prototype.name="cancel";
...
var lm=_.Rb=_.Rb||{};window.___jsl=window.___jsl||{};lm.xh={B:function(){return window.___jsl.bsh},Ok:function(){return window.___jsl.h},pj:function(a){window.___jsl.bsh=a},ys:function(a){window.___jsl.h=a}};
...
_.Fn=function(){return Math.floor((new Date).getTime()/1E3)};var LC,MC;_.Vj=function(a,c){this.B=a;var f=c||{};this.M=Number(f.maxAge)||0;this.G=f.domain;this.ha=f.path;this.qa=!!f.secure};LC=/^[-+/_=.:|%&a-zA-Z0-9@]*$/;MC=/^[A-Z_][A-Z0-9_]{0,63}$/;_.Vj.prototype.read=function(){for(var a=this.B+"=",c=window.document.cookie.split(/;\s*/),f=0;f<c.length;++f){var g=c[f];if(0==g.indexOf(a))return g.substr(a.length)}};
...
var Ok;_.dk=function(a){this.B=a};Ok={};_.dk.prototype.read=function(){if(Ok.hasOwnProperty(this.B))return Ok[this.B]};_.dk.prototype.write=function(a){Ok[this.B]=a;return!0};_.dk.prototype.clear=function(){delete Ok[this.B]};_.dk.iterate=function(a){for(var c in Ok)Ok.hasOwnProperty(c)&&a(c,Ok[c])};
var aw,us;aw=function(){this.B=null;this.key=function(){return null};this.getItem=function(){return this.B};this.setItem=function(a,c){this.B=c;this.length=1};this.removeItem=function(){this.clear()};this.clear=function(){this.B=null;this.length=0};this.length=0};us=function(a){try{var c=a||window.sessionStorage;if(!c)return!1;c.setItem("gapi.sessionStorageTest","gapi.sessionStorageTest"+c.length);c.removeItem("gapi.sessionStorageTest");return!0}catch(f){return!1}};
_.fk=function(a,c){this.G=a;us(c)?this.B=c||window.sessionStorage:this.B=new aw};_.fk.prototype.read=function(){return this.B.getItem(this.G)};_.fk.prototype.write=function(a){try{this.B.setItem(this.G,a)}catch(c){return!1}return!0};_.fk.prototype.clear=function(){this.B.removeItem(this.G)};_.fk.iterate=function(a){if(us())for(var c=0,f=window.sessionStorage.length;c<f;++c){var g=window.sessionStorage.key(c);a(g,window.sessionStorage[g])}};
for(var qn=0;64>qn;++qn);_.Yi="https:"===window.location.protocol;_.dj=_.Yi||"http:"===window.location.protocol?_.Vj:_.dk;_.jj=function(a){var c=a.substr(1),f="",g=window.location.hostname;if(""!==c){f=(0,window.parseInt)(c,10);if((0,window.isNaN)(f))return null;c=g.split(".");if(c.length<f-1)return null;c.length==f-1&&(g="."+g)}else g="";return{Gb:"S"==a.charAt(0),domain:g,Ke:f}};
...
_.kk=function(a,c,f){a=a&&"token"!==a?_.ik(a):_.jk();if(!a)return null;if(f){f=a.Kc;_.r();var g=f.G.read();f=null;try{f=(0,_.of)(g)}catch(h){}0==f&&(f=null);g=_.Dh()||"0";g=String(g);f=f&&f[g]}else f=a.Kc.read();f&&f.expires_at&&_.Fn()>f.expires_at&&(a.Kc.clear(),f=null);f&&f.error&&!c&&(f=null);return f};
...
var lk,tf;_.$e=function(){return _.pf("Opera")||_.pf("OPR")};lk=function(a,c){return a<c?-1:a>c?1:0};_.Ae=function(a,c,f){return 2>=arguments.length?_.ye.slice.call(a,c):_.ye.slice.call(a,c,f)};tf="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");
...
_.Eh=function(a){return null==a?"":String(a)};_.sf=function(a,c){for(var f,g,h=1;h<arguments.length;h++){g=arguments[h];for(f in g)a[f]=g[f];for(var l=0;l<tf.length;l++)f=tf[l],Object.prototype.hasOwnProperty.call(g,f)&&(a[f]=g[f])}};_.qf=function(a,c,f){for(var g in a)c.call(f,a[g],g,a)};_.ze=function(a){var c=a.length;if(0<c){for(var f=Array(c),g=0;g<c;g++)f[g]=a[g];return f}return[]};_.jr=function(a,c){var f=a.length-c.length;return 0<=f&&a.indexOf(c,f)==f}; _.mZ=function(){return _.pf("iPhone")&&!_.pf("iPod")&&!_.pf("iPad")};_.wk=function(){return _.mZ()||_.pf("iPad")||_.pf("iPod")};
var Pp,Pe,Zk,sh;_.cf=_.$e();_.W=_.Te();_.yk=_.pf("Edge");_.df=_.pf("Gecko")&&!(-1!=_.We.toLowerCase().indexOf("webkit")&&!_.pf("Edge"))&&!(_.pf("Trident")||_.pf("MSIE"))&&!_.pf("Edge");_.ef=-1!=_.We.toLowerCase().indexOf("webkit")&&!_.pf("Edge");_.ff=_.ef&&_.pf("Mobile");_.Gg=_.pf("Macintosh");_.Hg=_.pf("Windows");_.Jg=_.pf("Linux")||_.pf("CrOS");_.Ui=_.pf("Android");_.mk=_.mZ();_.sk=_.pf("iPad");
Pp=function(){var a=_.We;if(_.df)return/rv\:([^\);]+)(\)|;)/.exec(a);if(_.yk)return/Edge\/([\d\.]+)/.exec(a);if(_.W)return/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);if(_.ef)return/WebKit\/(\S+)/.exec(a)};Pe=function(){var a=_.D.document;return a?a.documentMode:void 0};_.Se=function(){if(_.cf&&_.D.opera){var a=_.D.opera.version;return _.vd(a)?a():a}var a="",c=Pp();c&&(a=c?c[1]:"");return _.W&&(c=Pe(),c>(0,window.parseFloat)(a))?String(c):a}();Zk={}; _.sl=function(a){return Zk[a]||(Zk[a]=0<=_.rk(_.Se,a))};sh=_.D.document;_.Ue=sh&&_.W?Pe()||("CSS1Compat"==sh.compatMode?(0,window.parseInt)(_.Se,10):5):void 0;

var Ti,Xi,Wi;_.im=function(a){return/^[\s\xa0]*$/.test(a)};Ti=function(a){return Array.prototype.join.call(arguments,"")};_.fq=function(a){return(0,window.encodeURIComponent)(String(a))};Xi=/^(?:([^:/?#.]+):)?(?:\/\/(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\?([^#]*))?(?:#(.*))?$/;_.Vi=function(a){if(Wi){Wi=!1;var c=_.D.location;if(c){var f=c.href;if(f&&(f=(f=_.Vi(f)[3]||null)?(0,window.decodeURI)(f):f)&&f!=c.hostname)throw Wi=!0,Error();}}return a.match(Xi)};Wi=_.ef;
_.Zi=function(a){if(a[1]){var c=a[0],f=c.indexOf("#");0<=f&&(a.push(c.substr(f)),a[0]=c=c.substr(0,f));f=c.indexOf("?");0>f?a[1]="?":f==c.length-1&&(a[1]=void 0)}return a.join("")};_.$i=function(a,c,f){if(_.ea(c))for(var g=0;g<c.length;g++)_.$i(a,String(c[g]),f);else null!=c&&f.push("&",a,""===c?"":"=",_.fq(c))};_.aj=function(a,c){for(var f in c)_.$i(f,c[f],a);return a};_.ul=function(a,c){_.jr(a,"/")&&(a=a.substr(0,a.length-1));_.jd(c,"/")&&(c=c.substr(1));return Ti(a,"/",c)};

var B,zk;B=function(a){return _.im(_.Eh(a))};zk=function(a,c){var f=_.R.Fh({id:a,name:a});f.style.width="1px";f.style.height="1px";f.style.position="absolute";f.style.top="-100px";var g;if(window.navigator){g=window.navigator.userAgent||"";var h=window.navigator.product||"";g=0!=g.indexOf("Opera")&&-1==g.indexOf("WebKit")&&"Gecko"==h&&0<g.indexOf("rv:1.")}else g=!1;f.src=g?"about:blank":c;f.tabIndex="-1";window.document.body.appendChild(f);g&&(f.src=c);return f};
_.Bk=function(){function a(){return!!v("auth/useFirstPartyAuthV2")}function c(a,c,f,g){var h=v("proxy");if(f||!h)var h=v("root"),l=v("root-1p")||h,n=v("xd3"),h=(f||String(c?l:h))+n;(c=_.R.dc().jsh||_.Rb.xh.Ok())&&(h+=(0<=h.indexOf("?")?"&":"?")+"jsh="+(0,window.encodeURIComponent)(c));v("push")&&(h+=(0<=h.indexOf("?")?"&":"?")+"p=1");h+="#parent="+(0,window.encodeURIComponent)(null!=g?String(g):_.Rb.Pq(window.document.location.href));return h+("&rpctoken="+a)}function f(a,c,f,g){var l=h(f,g);A[l]||
(f=zk(l,c),_.T.register("ready:"+a,function(){_.T.unregister("ready:"+a);if(!F[l]){F[l]=!0;var c=z[l];z[l]=[];for(var f=0,g=c.length;f<g;++f){var h=c[f];q(h.qf,h.$r,h.Ga)}}}),_.T.tf(l,c),A[l]=f)}function g(a,g){var h=String(2147483647*(0,_.Vb)()|0),l=c(h,a,g);_.$g(function(){f(h,l,a,g)})}function h(a,f){var g=c("",a,f,""),h=w[g];if(!h){h=_.Tb();h.update(g);var h=h.Of().toLowerCase(),l=Math.random(),h=h+l;w[g]=h}return"apiproxy"+h}function l(a){if(!a)return null;var c={},f=a.headers||{},g;for(g in f)({}).hasOwnProperty.call(f,
...
("oauth2"==h||"auto"==h)&&(g=String(l.token_type||"Bearer")+" "+l.access_token);if(l=!g)l=(!!v("auth/useFirstPartyAuth")||"1p"==h)&&"oauth2"!=h;if(l&&_.Qj.er()){if(a()){g=v("primaryEmail");var h=v("appDomain"),l=v("fogId"),n=[];g&&n.push({key:"e",value:g});h&&n.push({key:"a",value:h});l&&n.push({key:"u",value:l});g=_.Qj.Qe(n)}else g=_.Qj.Qe();g&&(f=_.google.mr(f),f=c["X-Goog-AuthUser"]||f,B(f)&&(!a()||a()&&B(v("primaryEmail"))&&B(v("appDomain"))&&B(v("fogId")))&&(f="0"),B(f)||(c["X-Goog-AuthUser"]= f))}g?c.Authorization=g:!1!==v("auth/useOriginToken")&&(l=_.Qj.bq())&&(c.OriginToken=l)}return c},B:t,Dd:q}}();

_.ue=function(a,c){var f;a:{f=a.length;for(var g=_.fa(a)?a.split(""):a,h=0;h<f;h++)if(h in g&&c.call(void 0,g[h],h,a)){f=h;break a}f=-1}return 0>f?null:_.fa(a)?a.charAt(f):a[f]};_.fh=function(a,c){for(var f=a.split("."),g=c||_.D,h;h=f.shift();)if(null!=g[h])g=g[h];else return null;return g};_.wd=function(a,c){return 1==_.ye.splice.call(a,c,1).length};_.xe=function(a,c){var f=(0,_.we)(a,c),g;(g=0<=f)&&_.wd(a,f);return g};
_.dh=function(){this.Oj=this.Oj;this.pa=this.pa};_.dh.prototype.Oj=!1;_.dh.prototype.Ma=function(){return this.Oj};_.dh.prototype.U=function(){this.Oj||(this.Oj=!0,this.C())};_.pD=function(a,c){var f=_.ma(_.eh,c);a.Oj?f.call(void 0):(a.pa||(a.pa=[]),a.pa.push(_.kf(void 0)?(0,_.H)(f,void 0):f))};_.dh.prototype.C=function(){if(this.pa)for(;this.pa.length;)this.pa.shift()()};_.eh=function(a){a&&"function"==typeof a.U&&a.U()};
_.mh=function(a,c){this.type=a;this.currentTarget=this.target=c;this.defaultPrevented=this.Ad=!1;this.Tg=!0};_.mh.prototype.stopPropagation=function(){this.Ad=!0};_.mh.prototype.preventDefault=function(){this.defaultPrevented=!0;this.Tg=!1};var lh=function(a){lh[" "](a);return a};lh[" "]=_.gh;var yh,Jh;_.Ih=!_.W||9<=_.Ue;yh=!_.W||9<=_.Ue;Jh=_.W&&!_.sl("9");!_.ef||_.sl("528");_.df&&_.sl("1.9b")||_.W&&_.sl("8")||_.cf&&_.sl("9.5")||_.ef&&_.sl("528");_.df&&!_.sl("8")||_.W&&_.sl("9");_.Ur=_.W?"focusin":"DOMFocusIn";_.as=_.W?"focusout":"DOMFocusOut";_.cs=_.ef?"webkitTransitionEnd":_.cf?"otransitionend":"transitionend";_.nh=function(a,c){_.mh.call(this,a?a.type:"");this.relatedTarget=this.currentTarget=this.target=null;this.charCode=this.keyCode=this.button=this.screenY=this.screenX=this.clientY=this.clientX=this.offsetY=this.offsetX=0;this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1;this.state=null;this.fj=!1;this.eo=null;a&&this.kc(a,c)};_.J(_.nh,_.mh);
_.nh.prototype.kc=function(a,c){var f=this.type=a.type;this.target=a.target||a.srcElement;this.currentTarget=c;var g=a.relatedTarget;if(g){if(_.df){var h;a:{try{lh(g.nodeName);h=!0;break a}catch(l){}h=!1}h||(g=null)}}else"mouseover"==f?g=a.fromElement:"mouseout"==f&&(g=a.toElement);this.relatedTarget=g;this.offsetX=_.ef||void 0!==a.offsetX?a.offsetX:a.layerX;this.offsetY=_.ef||void 0!==a.offsetY?a.offsetY:a.layerY;this.clientX=void 0!==a.clientX?a.clientX:a.pageX;this.clientY=void 0!==a.clientY?a.clientY:
a.pageY;this.screenX=a.screenX||0;this.screenY=a.screenY||0;this.button=a.button;this.keyCode=a.keyCode||0;this.charCode=a.charCode||("keypress"==f?a.keyCode:0);this.ctrlKey=a.ctrlKey;this.altKey=a.altKey;this.shiftKey=a.shiftKey;this.metaKey=a.metaKey;this.fj=_.Gg?a.metaKey:a.ctrlKey;this.state=a.state;this.eo=a;a.defaultPrevented&&this.preventDefault()};
_.nh.prototype.stopPropagation=function(){_.nh.T.stopPropagation.call(this);this.eo.stopPropagation?this.eo.stopPropagation():this.eo.cancelBubble=!0};_.nh.prototype.preventDefault=function(){_.nh.T.preventDefault.call(this);var a=this.eo;if(a.preventDefault)a.preventDefault();else if(a.returnValue=!1,Jh)try{if(a.ctrlKey||112<=a.keyCode&&123>=a.keyCode)a.keyCode=-1}catch(c){}};_.nh.prototype.Op=function(){return this.eo};
var cC,Lh;cC="closure_listenable_"+(1E6*Math.random()|0);_.wB=function(a){return!(!a||!a[cC])};Lh=0;var oh=function(a,c,f,g,h){this.listener=a;this.B=null;this.src=c;this.type=f;this.hR=!!g;this.Tc=h;this.key=++Lh;this.gR=this.If=!1},hs=function(a){a.gR=!0;a.listener=null;a.B=null;a.src=null;a.Tc=null};var ts=function(a){this.src=a;this.B={};this.G=0},et,zs;ts.prototype.add=function(a,c,f,g,h){var l=a.toString();a=this.B[l];a||(a=this.B[l]=[],this.G++);var n=zs(a,c,g,h);-1<n?(c=a[n],f||(c.If=!1)):(c=new oh(c,this.src,l,!!g,h),c.If=f,a.push(c));return c};ts.prototype.remove=function(a,c,f,g){a=a.toString();if(!(a in this.B))return!1;var h=this.B[a];c=zs(h,c,f,g);return-1<c?(hs(h[c]),_.wd(h,c),0==h.length&&(delete this.B[a],this.G--),!0):!1};
et=function(a,c){var f=c.type;f in a.B&&_.xe(a.B[f],c)&&(hs(c),0==a.B[f].length&&(delete a.B[f],a.G--))};_.ht=function(a,c,f,g,h){a=a.B[c.toString()];c=-1;a&&(c=zs(a,f,g,h));return-1<c?a[c]:null};zs=function(a,c,f,g){for(var h=0;h<a.length;++h){var l=a[h];if(!l.gR&&l.listener==c&&l.hR==!!f&&l.Tc==g)return h}return-1};
...
qh=function(a,c,f,g,h,l){if(!c)throw Error("u");var n=!!h,q=_.zt(a);q||(a[lt]=q=new ts(a));f=q.add(c,f,g,h,l);if(f.B)return f;g=th();f.B=g;g.src=a;g.listener=f;if(a.addEventListener)a.addEventListener(c.toString(),g,n);else if(a.attachEvent)a.attachEvent(Gk(c.toString()),g);else throw Error("c");st++;return f};th=function(){var a=xh,c=yh?function(f){return a.call(c.src,c.listener,f)}:function(f){f=a.call(c.src,c.listener,f);if(!f)return f};return c};
_.zh=function(a,c,f,g,h){if(_.ea(c)){for(var l=0;l<c.length;l++)_.zh(a,c[l],f,g,h);return null}f=_.tl(f);return _.wB(a)?a.gc.add(String(c),f,!0,g,h):qh(a,c,f,!0,g,h)};_.Ah=function(a,c,f,g,h){if(_.ea(c))for(var l=0;l<c.length;l++)_.Ah(a,c[l],f,g,h);else f=_.tl(f),_.wB(a)?a.cb(c,f,g,h):a&&(a=_.zt(a))&&(c=_.ht(a,c,f,!!g,h))&&_.Ch(c)};
_.Ch=function(a){if(!_.qe(a)&&a&&!a.gR){var c=a.src;if(_.wB(c))et(c.gc,a);else{var f=a.type,g=a.B;c.removeEventListener?c.removeEventListener(f,g,a.hR):c.detachEvent&&c.detachEvent(Gk(f),g);st--;(f=_.zt(c))?(et(f,a),0==f.G&&(f.src=null,c[lt]=null)):hs(a)}}};Gk=function(a){return a in vh?vh[a]:vh[a]="on"+a};Fh=function(a,c,f,g){var h=!0;if(a=_.zt(a))if(c=a.B[c.toString()])for(c=c.concat(),a=0;a<c.length;a++){var l=c[a];l&&l.hR==f&&!l.gR&&(l=Gh(l,g),h=h&&!1!==l)}return h};
Gh=function(a,c){var f=a.listener,g=a.Tc||a.src;a.If&&_.Ch(a);return f.call(g,c)};
xh=function(a,c){if(a.gR)return!0;if(!yh){var f=c||_.fh("window.event"),g=new _.nh(f,this),h=!0;if(!(0>f.keyCode||void 0!=f.returnValue)){a:{var l=!1;if(0==f.keyCode)try{f.keyCode=-1;break a}catch(n){l=!0}if(l||void 0==f.returnValue)f.returnValue=!0}f=[];for(l=g.currentTarget;l;l=l.parentNode)f.push(l);for(var l=a.type,q=f.length-1;!g.Ad&&0<=q;q--){g.currentTarget=f[q];var t=Fh(f[q],l,!0,g),h=h&&t}for(q=0;!g.Ad&&q<f.length;q++)g.currentTarget=f[q],t=Fh(f[q],l,!1,g),h=h&&t}return h}return Gh(a,new _.nh(c, this))};_.zt=function(a){a=a[lt];return a instanceof ts?a:null};lC="__closure_events_fn_"+(1E9*Math.random()>>>0);_.tl=function(a){if(_.vd(a))return a;a[lC]||(a[lC]=function(c){return a.handleEvent(c)});return a[lC]};_.hh(function(a){xh=a(xh)});
_.Hh=function(){_.dh.call(this);this.gc=new ts(this);this.dL=this;this.zh=null};_.J(_.Hh,_.dh);_.Hh.prototype[cC]=!0;_.k=_.Hh.prototype;_.k.KR=function(){return this.zh};_.k.tj=_.b(1);_.k.addEventListener=function(a,c,f,g){_.ph(this,a,c,f,g)};_.k.removeEventListener=function(a,c,f,g){_.Ah(this,a,c,f,g)};
_.k.dispatchEvent=function(a){var c,f=this.KR();if(f)for(c=[];f;f=f.KR())c.push(f);var f=this.dL,g=a.type||a;if(_.fa(a))a=new _.mh(a,f);else if(a instanceof _.mh)a.target=a.target||f;else{var h=a;a=new _.mh(g,f);_.sf(a,h)}var h=!0,l;if(c)for(var n=c.length-1;!a.Ad&&0<=n;n--)l=a.currentTarget=c[n],h=pC(l,g,!0,a)&&h;a.Ad||(l=a.currentTarget=f,h=pC(l,g,!0,a)&&h,a.Ad||(h=pC(l,g,!1,a)&&h));if(c)for(n=0;!a.Ad&&n<c.length;n++)l=a.currentTarget=c[n],h=pC(l,g,!1,a)&&h;return h};
_.k.C=function(){_.Hh.T.C.call(this);if(this.gc){var a=this.gc,c=0,f;for(f in a.B){for(var g=a.B[f],h=0;h<g.length;h++)++c,hs(g[h]);delete a.B[f];a.G--}}this.zh=null};_.k.N=function(a,c,f,g){return this.gc.add(String(a),c,!1,f,g)};_.k.cb=function(a,c,f,g){return this.gc.remove(String(a),c,f,g)}; var pC=function(a,c,f,g){c=a.gc.B[String(c)];if(!c)return!0;c=c.concat();for(var h=!0,l=0;l<c.length;++l){var n=c[l];if(n&&!n.gR&&n.hR==f){var q=n.listener,t=n.Tc||n.src;n.If&&et(a.gc,n);h=!1!==q.call(t,g)&&h}}return h&&0!=g.Tg};

var uf;uf=function(a){var c=arguments.length;if(1==c&&_.ea(arguments[0]))return uf.apply(null,arguments[0]);for(var f={},g=0;g<c;g++)f[arguments[g]]=!0;return f};_.mm=uf("area base br col command embed hr img input keygen link meta param source track wbr".split(" "));
_.pm=function(){this.B="";this.G=_.nm};_.pm.prototype.nK=!0;_.nm={};_.pm.prototype.cR=_.b(4);_.vg=function(a){var c=new _.pm;c.B=a;return c};_.rm=_.vg("");_.NG=function(){this.B="";this.ha=_.XM;this.G=null};_.NG.prototype.mK=!0;_.NG.prototype.Im=_.b(6);_.NG.prototype.nK=!0;_.NG.prototype.cR=_.b(3);_.XM={};_.uk=function(a,c){var f=new _.NG;f.B=a;f.G=c;return f};_.uk("<!DOCTYPE html>",0);_.RG=_.uk("",0);
_.Ni=function(a){if("function"==typeof a.Va)return a.Va();if(_.fa(a))return a.split("");if(_.re(a)){for(var c=[],f=a.length,g=0;g<f;g++)c.push(a[g]);return c}return _.Li(a)};_.hz=function(a){if("function"==typeof a.$b)return a.$b();if("function"!=typeof a.Va){if(_.re(a)||_.fa(a)){var c=[];a=a.length;for(var f=0;f<a;f++)c.push(f);return c}return _.Ki(a)}}; _.Oi=function(a,c,f){if("function"==typeof a.forEach)a.forEach(c,f);else if(_.re(a)||_.fa(a))(0,_.Be)(a,c,f);else for(var g=_.hz(a),h=_.Ni(a),l=h.length,n=0;n<l;n++)c.call(f,h[n],g&&g[n],a)};
...
_.Pi=function(a,c){this.G={};this.B=[];this.qa=this.M=0;var f=arguments.length;if(1<f){if(f%2)throw Error("q");for(var g=0;g<f;g+=2)this.set(arguments[g],arguments[g+1])}else if(a){a instanceof _.Pi?(f=a.$b(),g=a.Va()):(f=_.Ki(a),g=_.Li(a));for(var h=0;h<f.length;h++)this.set(f[h],g[h])}};_.k=_.Pi.prototype;_.k.Da=function(){return this.M};_.k.Va=function(){Qi(this);for(var a=[],c=0;c<this.B.length;c++)a.push(this.G[this.B[c]]);return a};_.k.$b=function(){Qi(this);return this.B.concat()};_.k.zn=_.b(7);
_.k.equals=function(a,c){if(this===a)return!0;if(this.M!=a.Da())return!1;var f=c||kA;Qi(this);for(var g,h=0;g=this.B[h];h++)if(!f(this.get(g),a.get(g)))return!1;return!0};var kA=function(a,c){return a===c};_.Pi.prototype.isEmpty=function(){return 0==this.M};_.Pi.prototype.clear=function(){this.G={};this.qa=this.M=this.B.length=0};_.Pi.prototype.remove=function(a){return _.Ri(this.G,a)?(delete this.G[a],this.M--,this.qa++,this.B.length>2*this.M&&Qi(this),!0):!1};
var Qi=function(a){if(a.M!=a.B.length){for(var c=0,f=0;c<a.B.length;){var g=a.B[c];_.Ri(a.G,g)&&(a.B[f++]=g);c++}a.B.length=f}if(a.M!=a.B.length){for(var h={},f=c=0;c<a.B.length;)g=a.B[c],_.Ri(h,g)||(a.B[f++]=g,h[g]=1),c++;a.B.length=f}};_.k=_.Pi.prototype;_.k.get=function(a,c){return _.Ri(this.G,a)?this.G[a]:c};_.k.set=function(a,c){_.Ri(this.G,a)||(this.M++,this.B.push(a),this.qa++);this.G[a]=c};
_.k.forEach=function(a,c){for(var f=this.$b(),g=0;g<f.length;g++){var h=f[g],l=this.get(h);a.call(c,l,h,this)}};_.k.clone=function(){return new _.Pi(this)};_.k.xc=function(a){Qi(this);var c=0,f=this.qa,g=this,h=new _.Mi;h.next=function(){if(f!=g.qa)throw Error("z");if(c>=g.B.length)throw _.Si;var h=g.B[c++];return a?h:g.G[h]};return h};_.Ri=function(a,c){return Object.prototype.hasOwnProperty.call(a,c)};

var rA,wA;_.Pi.prototype.zn=_.d(7,function(a){for(var c=0;c<this.B.length;c++){var f=this.B[c];if(_.Ri(this.G,f)&&this.G[f]==a)return!0}return!1});_.qA=function(a){var c=0,f;for(f in a)c++;return c};rA=function(a,c){if("function"==typeof a.every)return a.every(c,void 0);if(_.re(a)||_.fa(a))return(0,_.Fe)(a,c,void 0);for(var f=_.hz(a),g=_.Ni(a),h=g.length,l=0;l<h;l++)if(!c.call(void 0,g[l],f&&f[l],a))return!1;return!0};wA=function(a){return"function"==typeof a.Da?a.Da():_.re(a)||_.fa(a)?a.length:_.qA(a)};
var Hn;_.Gn=function(a){this.B=new _.Pi;if(a){a=_.Ni(a);for(var c=a.length,f=0;f<c;f++)this.add(a[f])}};Hn=function(a){var c=typeof a;return"object"==c&&a||"function"==c?"o"+_.oe(a):c.substr(0,1)+a};_.k=_.Gn.prototype;_.k.Da=function(){return this.B.Da()};_.k.add=function(a){this.B.set(Hn(a),a)};_.k.remove=function(a){return this.B.remove(Hn(a))};_.k.clear=function(){this.B.clear()};_.k.isEmpty=function(){return this.B.isEmpty()};_.k.contains=function(a){a=Hn(a);return _.Ri(this.B.G,a)};_.k.Va=function(){return this.B.Va()};
_.k.clone=function(){return new _.Gn(this)};_.k.equals=function(a){return this.Da()==wA(a)&&JA(this,a)};var JA=function(a,c){var f=wA(c);if(a.Da()>f)return!1;!("undefined"!=typeof _.Gn&&c instanceof _.Gn)&&5<f&&(c=new _.Gn(c));return rA(a,function(a){var f=c;return"function"==typeof f.contains?f.contains(a):"function"==typeof f.zn?f.zn(a):_.re(f)||_.fa(f)?_.ve(f,a):_.hi(f,a)})};_.Gn.prototype.xc=function(){return this.B.xc(!1)};

var xk,Qk,Dp,Sn,Cp;xk=function(a){return/^\s*$/.test(a)?!1:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,""))};_.Qn=function(a){a=String(a);if(xk(a))try{return eval("("+a+")")}catch(c){}throw Error("G`"+a);};_.PC=function(a){return _.cm(new _.zp(void 0),a)};_.zp=function(a){this.B=a};_.cm=function(a,c){var f=[];Qk(a,c,f);return f.join("")};
Qk=function(a,c,f){if(null==c)f.push("null");else{if("object"==typeof c){if(_.ea(c)){var g=c;c=g.length;f.push("[");for(var h="",l=0;l<c;l++)f.push(h),h=g[l],Qk(a,a.B?a.B.call(g,String(l),h):h,f),h=",";f.push("]");return}if(c instanceof String||c instanceof Number||c instanceof Boolean)c=c.valueOf();else{f.push("{");l="";for(g in c)Object.prototype.hasOwnProperty.call(c,g)&&(h=c[g],"function"!=typeof h&&(f.push(l),Cp(g,f),f.push(":"),Qk(a,a.B?a.B.call(c,g,h):h,f),l=","));f.push("}");return}}switch(typeof c){case "string":Cp(c,
f);break;case "number":f.push((0,window.isFinite)(c)&&!(0,window.isNaN)(c)?c:"null");break;case "boolean":f.push(c);break;case "function":break;default:throw Error("H`"+typeof c);}}};Dp={'"':'\\"',"\\":"\\\\","/":"\\/","\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t","\x0B":"\\u000b"};Sn=/\uffff/.test("\uffff")?/[\\\"\x00-\x1f\x7f-\uffff]/g:/[\\\"\x00-\x1f\x7f-\xff]/g; Cp=function(a,c){c.push('"',a.replace(Sn,function(a){var c=Dp[a];c||(c="\\u"+(a.charCodeAt(0)|65536).toString(16).substr(1),Dp[a]=c);return c}),'"')};
...
_.Em=function(a){switch(a){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:return!0;default:return!1}};_.QA=function(a){return eval("("+a+")")};_.Cr=function(a,c,f){a=a.split(c);for(var g=[];0<f&&a.length;)g.push(a.shift()),f--;a.length&&g.push(a.join(c));return g};
var Tn=function(){};Tn.prototype.B=null;var SA=function(a){var c;(c=a.B)||(c={},Vn(a)&&(c[0]=!0,c[1]=!0),c=a.B=c);return c};var Wn,Vn;Wn=function(){};_.J(Wn,Tn);_.Xn=function(a){return(a=Vn(a))?new window.ActiveXObject(a):new window.XMLHttpRequest};Vn=function(a){if(!a.G&&"undefined"==typeof window.XMLHttpRequest&&"undefined"!=typeof window.ActiveXObject){for(var c=["MSXML2.XMLHTTP.6.0","MSXML2.XMLHTTP.3.0","MSXML2.XMLHTTP","Microsoft.XMLHTTP"],f=0;f<c.length;f++){var g=c[f];try{return new window.ActiveXObject(g),a.G=g}catch(h){}}throw Error("I");}return a.G};_.fo=new Wn;
var go,VA,ko;_.Yn=function(a){_.Hh.call(this);this.headers=new _.Pi;this.zt=a||null;this.G=!1;this.po=this.B=null;this.Kh="";this.qa=0;this.ha=this.te=this.ye=this.Ei=!1;this.Ka=0;this.Ld=null;this.M="";this.eb=this.fb=!1};_.J(_.Yn,_.Hh);go=/^https?$/i;VA=["POST","PUT"];ko=[];_.mo=function(a,c,f,g,h,l){var n=new _.Yn;ko.push(n);c&&n.N("complete",c);n.gc.add("ready",n.Kb,!0,void 0,void 0);l&&(n.Ka=Math.max(0,l));n.send(a,f,g,h)};_.Yn.prototype.Kb=function(){this.U();_.xe(ko,this)};
_.Yn.prototype.Sk=function(){return this.M};
_.Yn.prototype.send=function(a,c,f,g){if(this.B)throw Error("J`"+this.Kh+"`"+a);c=c?c.toUpperCase():"GET";this.Kh=a;this.qa=0;this.Ei=!1;this.G=!0;this.B=this.zt?_.Xn(this.zt):_.Xn(_.fo);this.po=this.zt?SA(this.zt):SA(_.fo);this.B.onreadystatechange=(0,_.H)(this.Za,this);try{this.te=!0,this.B.open(c,String(a),!0),this.te=!1}catch(h){YA(this);return}a=f||"";var l=this.headers.clone();g&&_.Oi(g,function(a,c){l.set(c,a)});g=_.ue(l.$b(),SC);f=_.D.FormData&&a instanceof _.D.FormData;!_.ve(VA,c)||g||f||
l.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");l.forEach(function(a,c){this.B.setRequestHeader(c,a)},this);this.M&&(this.B.responseType=this.M);"withCredentials"in this.B&&(this.B.withCredentials=this.fb);try{$A(this),0<this.Ka&&((this.eb=aB(this.B))?(this.B.timeout=this.Ka,this.B.ontimeout=(0,_.H)(this.Ss,this)):this.Ld=_.Rn(this.Ss,this.Ka,this)),this.ye=!0,this.B.send(a),this.ye=!1}catch(n){YA(this)}};
var aB=function(a){return _.W&&_.sl(9)&&_.qe(a.timeout)&&_.kf(a.ontimeout)},SC=function(a){return"content-type"==a.toLowerCase()};_.Yn.prototype.Ss=function(){"undefined"!=typeof _.na&&this.B&&(this.qa=8,this.dispatchEvent("timeout"),this.abort(8))};var YA=function(a){a.G=!1;a.B&&(a.ha=!0,a.B.abort(),a.ha=!1);a.qa=5;$n(a);ao(a)},$n=function(a){a.Ei||(a.Ei=!0,a.dispatchEvent("complete"),a.dispatchEvent("error"))};
_.Yn.prototype.abort=function(a){this.B&&this.G&&(this.G=!1,this.ha=!0,this.B.abort(),this.ha=!1,this.qa=a||7,this.dispatchEvent("complete"),this.dispatchEvent("abort"),ao(this))};_.Yn.prototype.C=function(){this.B&&(this.G&&(this.G=!1,this.ha=!0,this.B.abort(),this.ha=!1),ao(this,!0));_.Yn.T.C.call(this)};_.Yn.prototype.Za=function(){this.Ma()||(this.te||this.ye||this.ha?bo(this):this.Na())};_.Yn.prototype.Na=function(){bo(this)};
var bo=function(a){if(a.G&&"undefined"!=typeof _.na&&(!a.po[1]||4!=_.iB(a)||2!=a.getStatus()))if(a.ye&&4==_.iB(a))_.Rn(a.Za,0,a);else if(a.dispatchEvent("readystatechange"),4==_.iB(a)){a.G=!1;try{_.Eu(a)?(a.dispatchEvent("complete"),a.dispatchEvent("success")):(a.qa=6,a.getStatus(),$n(a))}finally{ao(a)}}},ao=function(a,c){if(a.B){$A(a);var f=a.B,g=a.po[0]?_.gh:null;a.B=null;a.po=null;c||a.dispatchEvent("ready");try{f.onreadystatechange=g}catch(h){}}},$A=function(a){a.B&&a.eb&&(a.B.ontimeout=null);
_.qe(a.Ld)&&(_.Pt(a.Ld),a.Ld=null)};_.Yn.prototype.kh=function(){return!!this.B};_.Eu=function(a){var c=a.getStatus(),f;if(!(f=_.Em(c))){if(c=0===c)a=_.Vi(String(a.Kh))[1]||null,!a&&window.self.location&&(a=window.self.location.protocol,a=a.substr(0,a.length-1)),c=!go.test(a?a.toLowerCase():"");f=c}return f};_.iB=function(a){return a.B?a.B.readyState:0};_.Yn.prototype.getStatus=function(){try{return 2<_.iB(this)?this.B.status:-1}catch(a){return-1}};
_.KI=function(a){try{return a.B?a.B.responseText:""}catch(c){return""}};_.pA=function(a){try{if(!a.B)return null;if("response"in a.B)return a.B.response;switch(a.M){case "":case "text":return a.B.responseText;case "arraybuffer":if("mozResponseArrayBuffer"in a.B)return a.B.mozResponseArrayBuffer}return null}catch(c){return null}};_.Yn.prototype.getAllResponseHeaders=function(){return this.B&&4==_.iB(this)?this.B.getAllResponseHeaders():""};_.hh(function(a){_.Yn.prototype.Na=a(_.Yn.prototype.Na)});
...
var wm=function(){this.B={};this.G=_.L.Ui()};wm.prototype.add=function(a,c,f){this.B[a]=f;this.G.add(a,c);return this};wm.prototype.execute=function(a){var c=this;this.G.execute(function(f){var g={},h=!1,l;for(l in f)if(f.hasOwnProperty(l)){var n=f[l],q=c.B[l];q?q(n):(g[l]=n,h=!0)}h&&a&&a(g)})};
...
_.k.rp=function(a){var c=this.zd.B.onClose;c&&c.call(this,a,this);this.BC&&this.BC()||(a=this.rb())&&a.parentNode&&a.parentNode.removeChild(a);if(a=this.zd.B.controller)c={},c.frameName=this.Tp(),_.jA(a,"_g_disposeControl",c)};_.bA.prototype.Za=_.b(20);_.bA.prototype.fb=_.b(21);_.Rm.prototype.QE=_.b(22);_.Rm.prototype.PE=function(a,c){this.register("_g_wasClosed",a,c)};
...
var pu,Ye,Xe,Re,Me,Le,Ze,Ke;pu={};_.su=function(){this.B="";this.G=pu};_.su.prototype.nK=!0;_.su.prototype.cR=_.b(2);_.su.prototype.mK=!0;_.su.prototype.Im=_.b(5);Ye=/&/g;Xe=/</g;Re=/>/g;Me=/"/g;Le=/'/g;Ze=/\x00/g;Ke=/[\x00&<>"']/;
_.He=function(a){if(!Ke.test(a))return a;-1!=a.indexOf("&")&&(a=a.replace(Ye,"&amp;"));-1!=a.indexOf("<")&&(a=a.replace(Xe,"&lt;"));-1!=a.indexOf(">")&&(a=a.replace(Re,"&gt;"));-1!=a.indexOf('"')&&(a=a.replace(Me,"&quot;"));-1!=a.indexOf("'")&&(a=a.replace(Le,"&#39;"));-1!=a.indexOf("\x00")&&(a=a.replace(Ze,"&#0;"));return a};_.OG=function(a){return a instanceof _.NG&&a.constructor===_.NG&&a.ha===_.XM?a.B:"type_error:SafeHtml"}; _.Ls=function(a){return a instanceof _.su&&a.constructor===_.su&&a.G===pu?a.B:"type_error:SafeUrl"};

_.NG.prototype.Im=_.d(6,function(){return this.G});_.su.prototype.Im=_.d(5,function(){return 1});var Nf,Xo;Nf=!_.W||9<=_.Ue;Xo=!_.df&&!_.W||_.W&&9<=_.Ue||_.df&&_.sl("1.9.1");_.ag=_.W&&!_.sl("9");_.Zn=_.W||_.cf||_.ef;_.qm=_.W&&!(9<=_.Ue);var Ff,Of,Pf;_.Bf=function(a,c){var f=c||window.document;return f.querySelectorAll&&f.querySelector?f.querySelectorAll("."+a):_.Cf(window.document,"*",a,c)};_.Df=function(a,c){var f=c||window.document,g=null;f.getElementsByClassName?g=f.getElementsByClassName(a)[0]:f.querySelectorAll&&f.querySelector?g=f.querySelector("."+a):g=_.Cf(window.document,"*",a,c)[0];return g||null};
...
Of=function(a,c,f,g){function h(f){f&&c.appendChild(_.fa(f)?a.createTextNode(f):f)}for(;g<f.length;g++){var l=f[g];!_.re(l)||_.Vg(l)&&0<l.nodeType?h(l):(0,_.Be)(Pf(l)?_.ze(l):l,h)}};_.xp=function(a,c){Of(_.zf(a),a,arguments,1)};_.Qf=function(a){for(var c;c=a.firstChild;)a.removeChild(c)};_.Rf=function(a,c){c.parentNode&&c.parentNode.insertBefore(a,c)};_.Tf=function(a){return a&&a.parentNode?a.parentNode.removeChild(a):null};
...
_.Yf=function(a,c){if(a.contains&&1==c.nodeType)return a==c||a.contains(c);if("undefined"!=typeof a.compareDocumentPosition)return a==c||Boolean(a.compareDocumentPosition(c)&16);for(;c&&a!=c;)c=c.parentNode;return c==a};_.zf=function(a){return 9==a.nodeType?a:a.ownerDocument||a.document};
_.Zf=function(a,c){if("textContent"in a)a.textContent=c;else if(3==a.nodeType)a.data=c;else if(a.firstChild&&3==a.firstChild.nodeType){for(;a.lastChild!=a.firstChild;)a.removeChild(a.lastChild);a.firstChild.data=c}else _.Qf(a),a.appendChild(_.zf(a).createTextNode(String(c)))};Pf=function(a){if(a&&"number"==typeof a.length){if(_.Vg(a))return"function"==typeof a.item||"string"==typeof a.item;if(_.vd(a))return"function"==typeof a.item}return!1};_.yf=function(a){this.B=a||_.D.document||window.document};
_.k=_.yf.prototype;_.k.Z=_.b(0);_.k.R=function(a,c,f){return _.Mf(this.B,arguments)};_.k.createElement=function(a){return this.B.createElement(a)};_.k.Aa=function(){var a=this.B;return a.parentWindow||a.defaultView};_.k.appendChild=function(a,c){a.appendChild(c)};_.k.append=_.xp;_.k.uD=_.Qf;_.k.Sl=_.Rf;_.k.removeNode=_.Tf;_.k.Hp=_.Uf;_.k.NR=_.SO;_.k.Yd=_.Vf;_.k.isElement=_.iz;_.k.contains=_.Yf;

_.Uo=_.r();
_.Uu=function(a){var c=window;a=(a||c.location.href).match(/.*(\?|#|&)usegapi=([^&#]+)/)||[];return"1"===(0,window.decodeURIComponent)(a[a.length-1]||"")};
var eg,dg,bg,vU,Af;_.Lf=function(a){return"CSS1Compat"==a.compatMode};eg={IMG:" ",BR:"\n"};dg={SCRIPT:1,STYLE:1,HEAD:1,IFRAME:1,OBJECT:1};_.Kf=function(a){return a.scrollingElement?a.scrollingElement:!_.ef&&_.Lf(a)?a.documentElement:a.body||a.documentElement};_.fg=function(a,c){this.width=a;this.height=c};_.k=_.fg.prototype;_.k.clone=function(){return new _.fg(this.width,this.height)};_.k.isEmpty=function(){return!(this.width*this.height)};_.k.ceil=_.b(9);
_.k.floor=function(){this.width=Math.floor(this.width);this.height=Math.floor(this.height);return this};_.k.round=function(){this.width=Math.round(this.width);this.height=Math.round(this.height);return this};_.X=function(a,c){this.x=_.kf(a)?a:0;this.y=_.kf(c)?c:0};_.k=_.X.prototype;_.k.clone=function(){return new _.X(this.x,this.y)};_.k.ceil=_.b(10);_.k.floor=function(){this.x=Math.floor(this.x);this.y=Math.floor(this.y);return this};
_.k.round=function(){this.x=Math.round(this.x);this.y=Math.round(this.y);return this};_.k.translate=_.b(13);bg=function(a,c,f){if(!(a.nodeName in dg))if(3==a.nodeType)f?c.push(String(a.nodeValue).replace(/(\r\n|\r|\n)/g,"")):c.push(a.nodeValue);else if(a.nodeName in eg)c.push(eg[a.nodeName]);else for(a=a.firstChild;a;)bg(a,c,f),a=a.nextSibling};
_.Jf=function(a){var c=_.Kf(a);a=a.parentWindow||a.defaultView;return _.W&&_.sl("10")&&a.pageYOffset!=c.scrollTop?new _.X(c.scrollLeft,c.scrollTop):new _.X(a.pageXOffset||c.scrollLeft,a.pageYOffset||c.scrollTop)};_.Ct=function(a){a=a.document;a=_.Lf(a)?a.documentElement:a.body;return new _.fg(a.clientWidth,a.clientHeight)};_.eG=function(a){if(a instanceof _.NG)return a;var c=null;a.mK&&(c=a.Im());a=_.He(a.nK?a.cR():String(a));return _.uk(a,c)};
_.X.prototype.ceil=_.d(10,function(){this.x=Math.ceil(this.x);this.y=Math.ceil(this.y);return this});_.fg.prototype.ceil=_.d(9,function(){this.width=Math.ceil(this.width);this.height=Math.ceil(this.height);return this});_.pm.prototype.cR=_.d(4,function(){return this.B});_.NG.prototype.cR=_.d(3,function(){return this.B});_.su.prototype.cR=_.d(2,function(){return this.B});_.yf.prototype.Z=_.d(0,function(a){return _.fa(a)?this.B.getElementById(a):a});_.Hf=function(a){return _.Jf(a.B)};_.hg=function(a){return _.Lf(a.B)};
_.iM=function(a,c,f,g){return _.Cf(a.B,c,f,g)};_.$f=function(a){if(_.ag&&"innerText"in a)a=a.innerText.replace(/(\r\n|\r|\n)/g,"\n");else{var c=[];bg(a,c,!0);a=c.join("")}a=a.replace(/ \xAD /g," ").replace(/\xAD/g,"");a=a.replace(/\u200B/g,"");_.ag||(a=a.replace(/ +/g," "));" "!=a&&(a=a.replace(/^\s*/,""));return a};_.ig=function(a){return _.Ct(a||window)};vU=/^(?:(?:https?|mailto|ftp):|[^&:/?#]*(?:[/?#]|$))/i;_.Bw=function(a){return a instanceof _.pm&&a.constructor===_.pm&&a.G===_.nm?a.B:"type_error:SafeStyle"};
_.jw=function(a){if(a instanceof _.su)return a;a=a.nK?a.cR():String(a);vU.test(a)||(a="about:invalid#zClosurez");var c=new _.su;c.B=a;return c};_.xf=function(a){return a?new _.yf(_.zf(a)):Af||(Af=new _.yf)};_.Gp=function(a,c,f,g){return _.ye.splice.apply(a,_.Ae(arguments,1))};_.Gt=function(a){return String(a).replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g,"\\$1").replace(/\x08/g,"\\x08")};_.cg=function(a){var c=[];bg(a,c,!1);return c.join("")};
_.Sf=function(a,c){c.parentNode&&c.parentNode.insertBefore(a,c.nextSibling)};_.Ng=function(a,c,f){return _.Mf(window.document,arguments)};_.jg=function(a){return a?a.parentWindow||a.defaultView:window};_.kg=function(a){return _.fa(a)?window.document.getElementById(a):a};_.TO=function(a){var c=_.da(a);if("object"==c||"array"==c){if(a.clone)return a.clone();var c="array"==c?[]:{},f;for(f in a)c[f]=_.TO(a[f]);return c}return a};_.CM=function(a,c,f){if(c in a)throw Error("p`"+c);a[c]=f};
_.Dg=function(a){var c=_.fa(void 0)?_.Gt(void 0):"\\s";return a.replace(new RegExp("(^"+(c?"|["+c+"]+":"")+")([a-z])","g"),function(a,c,h){return c+h.toUpperCase()})};_.Ht=function(a,c){for(var f in c)a[f]=c[f]};_.Pg=function(a,c,f,g){this.top=a;this.right=c;this.bottom=f;this.left=g};_.k=_.Pg.prototype;_.k.Ne=_.b(14);_.k.Cd=function(){return this.bottom-this.top};_.k.clone=function(){return new _.Pg(this.top,this.right,this.bottom,this.left)};
_.k.contains=function(a){return this&&a?a instanceof _.Pg?a.left>=this.left&&a.right<=this.right&&a.top>=this.top&&a.bottom<=this.bottom:a.x>=this.left&&a.x<=this.right&&a.y>=this.top&&a.y<=this.bottom:!1};_.k.ceil=function(){this.top=Math.ceil(this.top);this.right=Math.ceil(this.right);this.bottom=Math.ceil(this.bottom);this.left=Math.ceil(this.left);return this};
_.k.floor=function(){this.top=Math.floor(this.top);this.right=Math.floor(this.right);this.bottom=Math.floor(this.bottom);this.left=Math.floor(this.left);return this};_.k.round=function(){this.top=Math.round(this.top);this.right=Math.round(this.right);this.bottom=Math.round(this.bottom);this.left=Math.round(this.left);return this};_.k.translate=_.b(12);
...
_.tg=function(a,c){var f=new _.X(0,0),g=_.jg(_.zf(a)),h=a;do{var l=g==c?_.sg(h):_.Kt(h);f.x+=l.x;f.y+=l.y}while(g&&g!=c&&g!=g.parent&&(h=g.frameElement)&&(g=g.parent));return f};_.Kt=function(a){a=qg(a);return new _.X(a.left,a.top)};_.wg=function(a,c,f){if(c instanceof _.fg)f=c.height,c=c.width;else if(void 0==f)throw Error("r");a.style.width=_.xg(c,!0);_.Lt(a,f)};_.xg=function(a,c){"number"==typeof a&&(a=(c?Math.round(a):a)+"px");return a};_.Lt=function(a,c){a.style.height=_.xg(c,!0)};
_.Nt=function(a){var c=zg;if("none"!=_.ng(a,"display"))return c(a);var f=a.style,g=f.display,h=f.visibility,l=f.position;f.visibility="hidden";f.position="absolute";f.display="inline";a=c(a);f.display=g;f.position=l;f.visibility=h;return a};zg=function(a){var c=a.offsetWidth,f=a.offsetHeight,g=_.ef&&!c&&!f;return _.kf(c)&&!g||!a.getBoundingClientRect?new _.fg(c,f):(a=qg(a),new _.fg(a.right-a.left,a.bottom-a.top))};_.Rj=function(a,c){a.style.display=c?"":"none"};
_.Xg=function(a){var c=_.xf(void 0),f=null,g=c.B;_.W&&g.createStyleSheet?(f=g.createStyleSheet(),_.HG(f,a)):(g=_.iM(c,"HEAD")[0],g||(f=_.iM(c,"BODY")[0],g=c.R("HEAD"),f.parentNode.insertBefore(g,f)),f=c.R("STYLE"),_.HG(f,a),c.appendChild(g,f));return f};_.HG=function(a,c){_.W&&_.kf(a.cssText)?a.cssText=c:a.innerHTML=c};_.Eg=function(a){return"rtl"==_.ng(a,"direction")};_.Bg=_.df?"MozUserSelect":_.ef?"WebkitUserSelect":null;
...
var ch,sv,rv;_.yx=function(a){for(var c=[],f=0,g=0;f<a.length;){var h=a[f++];if(128>h)c[g++]=String.fromCharCode(h);else if(191<h&&224>h){var l=a[f++];c[g++]=String.fromCharCode((h&31)<<6|l&63)}else{var l=a[f++],n=a[f++];c[g++]=String.fromCharCode((h&15)<<12|(l&63)<<6|n&63)}}return c.join("")};_.tv=null;ch=null;sv=null;rv=null;_.Kh=_.df||_.ef||_.cf||"function"==typeof _.D.atob;
_.MA=function(a,c){var f;if(_.Kh&&!c)f=_.D.atob(a);else if(f=_.Ks(a,c),8192>=f.length)f=String.fromCharCode.apply(null,f);else{for(var g="",h=0;h<f.length;h+=8192)g+=String.fromCharCode.apply(null,_.Ae(f,h,h+8192));f=g}return f};
...
_.rF=function(a){this.B=a};_.rF.prototype.toString=function(){return this.B};_.fp=function(){_.dh.call(this);this.qa=1;this.ha=[];this.M=0;this.B=[];this.G={}};_.J(_.fp,_.dh);_.k=_.fp.prototype;_.k.subscribe=_.b(34);_.k.zf=function(a){if(0!=this.M)return this.ha.push(a),!1;var c=this.B[a];if(c){var f=this.G[c];f&&_.xe(f,a);delete this.B[a];delete this.B[a+1];delete this.B[a+2]}return!!c};
_.k.iu=function(a,c){var f=this.G[a];if(f){this.M++;for(var g=Array(arguments.length-1),h=1,l=arguments.length;h<l;h++)g[h-1]=arguments[h];h=0;for(l=f.length;h<l;h++){var n=f[h];this.B[n+1].apply(this.B[n+2],g)}this.M--;if(0<this.ha.length&&0==this.M)for(;f=this.ha.pop();)this.zf(f);return 0!=h}return!1};_.k.clear=function(a){if(a){var c=this.G[a];c&&((0,_.Be)(c,this.zf,this),delete this.G[a])}else this.B.length=0,this.G={}}; _.k.Da=function(a){if(a){var c=this.G[a];return c?c.length:0}a=0;for(c in this.G)a+=this.Da(c);return a};_.k.C=function(){_.fp.T.C.call(this);this.clear();this.ha.length=0};
_.lH=function(){_.dh.call(this);this.B=new _.fp;_.pD(this,this.B)};_.J(_.lH,_.dh);_.lH.prototype.subscribe=_.b(33);_.lH.prototype.zf=function(a){return this.B.zf(a)};_.lH.prototype.clear=function(a){this.B.clear(_.kf(a)?a.toString():void 0)};_.lH.prototype.Da=function(a){return this.B.Da(_.kf(a)?a.toString():void 0)};

var Us={},ou=function(){this.B=Us},WD,qu,ru,sm,tu,uu,tm,Fp;ou.prototype.nK=!0;ou.prototype.cR=function(){return""};ou.prototype.toString=function(){return"Const{}"};WD={};qu=/^[-,."'%_!# a-zA-Z0-9]+$/;ru=function(a){return a instanceof ou&&a.constructor===ou&&a.B===Us?"":"type_error:Const"};_.qE=function(){this.B=WD};_.qE.prototype.nK=!0;_.qE.prototype.cR=function(){return""};_.qE.prototype.mK=!0;_.qE.prototype.Im=function(){return 1};
sm={action:!0,cite:!0,data:!0,formaction:!0,href:!0,manifest:!0,poster:!0,src:!0};_.wx=function(a){return a instanceof _.qE&&a.constructor===_.qE&&a.B===WD?"":"type_error:TrustedResourceUrl"};tu=function(a){var c=0,f="",g=function(a){_.ea(a)?(0,_.Be)(a,g):(a=_.eG(a),f+=_.OG(a),a=a.Im(),0==c?c=a:0!=a&&c!=a&&(c=null))};(0,_.Be)(arguments,g);return _.uk(f,c)};uu=/^[a-zA-Z0-9-]+$/;tm={EMBED:!0,IFRAME:!0,LINK:!0,OBJECT:!0,SCRIPT:!0,STYLE:!0,TEMPLATE:!0};Fp=function(a,c){return a>c?1:a<c?-1:0};
_.kB=function(a,c){a.sort(c||Fp)};_.Nk=function(a,c){_.ea(c)||(c=[c]);var f=(0,_.De)(c,function(a){return _.fa(a)?a:a.Rr+" "+a.duration+"s "+a.timing+" "+a.Le+"s"});_.Mg(a,"transition",f.join(","))};
_.Pk=function(a){var c=!1,f;return function(){c||(f=a(),c=!0);return f}}(function(){if(_.W)return _.sl("10.0");var a=window.document.createElement("DIV"),c=_.ef?"-webkit":_.df?"-moz":_.W?"-ms":_.cf?"-o":null,f={transition:"opacity 1s linear"};c&&(f[c+"-transition"]="opacity 1s linear");c={style:f};if(!uu.test("div"))throw Error("s`div");if("DIV"in tm)throw Error("D`div");var f=null,g="<div";if(c)for(var h in c){if(!uu.test(h))throw Error("E`"+h);var l=c[h];if(null!=l){var n;n=h;if(l instanceof ou)l=
ru(l);else if("style"==n.toLowerCase()){if(!_.Vg(l))throw Error("M`"+typeof l+"`"+l);if(!(l instanceof _.pm)){var q="",t=void 0;for(t in l){if(!/^[-_a-zA-Z0-9]+$/.test(t))throw Error("e`"+t);var v=l[t];if(null!=v){if(v instanceof ou)v=ru(v);else if(qu.test(v)){for(var w=!0,A=!0,F=0;F<v.length;F++){var z=v.charAt(F);"'"==z&&A?w=!w:'"'==z&&w&&(A=!A)}w&&A||(v="zClosurez")}else v="zClosurez";q+=t+":"+v+";"}}l=q?_.vg(q):_.rm}l=_.Bw(l)}else{if(/^on/i.test(n))throw Error("F`"+n+"`"+l);if(n.toLowerCase()in
sm)if(l instanceof _.qE)l=_.wx(l);else if(l instanceof _.su)l=_.Ls(l);else if(_.fa(l))l=_.jw(l).cR();else throw Error("ea`"+n+"`div`"+l);}l.nK&&(l=l.cR());n=n+'="'+_.He(String(l))+'"';g=g+(" "+n)}}h=void 0;null!=h?_.ea(h)||(h=[h]):h=[];!0===_.mm.div?g+=">":(f=tu(h),g+=">"+_.OG(f)+"</div>",f=f.Im());(c=c&&c.dir)&&(/^(ltr|rtl|auto)$/i.test(c)?f=0:f=null);c=_.uk(g,f);a.innerHTML=_.OG(c);a=a.firstChild;c=a.style[_.Cg("transition")];return""!=("undefined"!==typeof c?c:a.style[_.Fg(a,"transition")]||"")});

_.Au=function(){_.wu="oauth2relay"+String(2147483647*(0,_.Vb)()|0);_.Qt.proxy=_.wu};_.Bu=new _.lH;_.mH=new _.rF("oauth");_.Qt={};_.Au();var XC=_.P("oauth-flow/client_id");_.Qt.client_id=XC;var yE=_.Qt,UE;var gN=String(_.P("oauth-flow/redirectUri"));if(gN)UE=gN.replace(/[#][\s\S]*/,"");else{var iN=_.Rb.Pq(window.location.href);UE=[_.P("oauth-flow/callbackUrl"),"?x_origin=",(0,window.encodeURIComponent)(iN)].join("")}yE.redirect_uri=UE;_.Qt.origin=_.Rb.Pq(window.location.href);_.Qt.response_type="token";
...
l.toString===Object.prototype.toString||l.toString===Array.prototype.toString);if(l)try{f[q]=(0,_.mf)(f[q])}catch(t){delete f[q]}}q=!0;f.dontclear&&(q=!1);delete f.dontclear;var v,w,A;l={};var F=A=a;"plus"==a&&f.action&&(A=a+"_"+f.action,F=a+"/"+f.action);(A=_.P("iframes/"+A+"/url"))||(A=":im_socialhost:/:session_prefix::im_prefix:_/widget/render/"+F+"?usegapi=1");for(w in Wo)l[w]=w+"/"+(f[w]||Wo[w])+"/";w=_.An(_.ua,A.replace(_.nc,dC(l)));F="iframes/"+a+"/params/";l={};_.Sl(f,l);(A=_.P("lang")||_.P("gwidget/lang"))&&
(l.hl=A);av[a]||(l.origin=_.md());l.exp=_.P(F+"exp");if(F=_.P(F+"location"))for(A=0;A<F.length;A++){var z=F[A];l[z]=_.ta.location[z]}switch(a){case "plus":case "follow":l.url=_.ld(l.href,f);delete l.href;break;case "plusone":F=(F=f.href)?Xc(F):_.Yc();l.url=F;l.db=_.fd(f.db,0,_.P());l.ecp=_.gd(f.ecp,0,_.P());delete l.href;break;case "signin":l.url=_.Yc()}_.bb.ILI&&(l.iloader="1");delete l["data-onload"];delete l.rd;for(var I in Wo)l[I]&&delete l[I];l.gsrc=_.P("iframes/:source:");I=_.P("inline/css");
"undefined"!==typeof I&&0<h&&I>=h&&(l.ic="1");I=/^#|^fr-/;h={};for(var E in l)_.Qa(l,E)&&I.test(E)&&(h[E.replace(I,"")]=l[E],delete l[E]);E="q"==_.P("iframes/"+a+"/params/si")?l:h;I=_.Xu();for(var K in I)!_.Qa(I,K)||_.Qa(l,K)||_.Qa(h,K)||(E[K]=I[K]);K=[].concat(Ld);E=_.P("iframes/"+a+"/methods");_.cb(E)&&(K=K.concat(E));for(v in f)_.Qa(f,v)&&/^on/.test(v)&&("plus"!=a||"onconnect"!=v)&&(K.push(v),delete l[v]);delete l.callback;h._methods=K.join(",");v=_.Bn(w,l,h);K=n||{};K.allowPost=1;K.attributes=
Md;K.dontclear=!q;n={};n.userParams=f;n.url=v;n.type=a;_.cv(a,c,f,v,K,n);c=n.id;f=_.r();f.id=c;f.userParams=n.userParams;f.url=n.url;f.type=n.type;f.state=1;_.Tc[c]=f;c=n}else c=null;c&&((f=c.id)&&g.push(f),Id(a,c))}},Jd=function(a,c,f){if(a&&1===a.nodeType&&c){if(f)return 1;if(Dd[c]){if(Yu[a.nodeName.toLowerCase()])return(a=a.innerHTML)&&a.replace(/^[\s\xa0]+|[\s\xa0]+$/g,"")?0:1}else{if(Cd[c])return 0;if(Bd[c])return 1}}return null};
...
Od("wrt","bs0","wrrt");Od("wji","wje0","wje1",!0);Od("wjli","wjl0","wjl1");Od("whi","wh0","wh1",!0);Od("wai","waaf0","waaf1",!0);Od("wadi","wrs","waaf1",!0);Od("wadt","bs0","waaf1",!0);Od("wprt","wrt0","wrt1");Od("wrqt","wrt1","wrt2");Od("wrst","wrt2","wrt3",!0);Od("fbprt","fsrt0","fsrt1");Od("fbrqt","fsrt1","fsrt2");Od("fbrst","fsrt2","fsrt3",!0);Od("fdns","fdns0","fdns1");Od("fcon","fcon0","fcon1");Od("freq","freq0","freq1");Od("frsp","frsp0","frsp1");Od("fttfb","fttfb0","fttfb1"); Od("ftot","ftot0","ftot1",!0);var dq=Rd.r;if("function"!==typeof dq){for(var eq;eq=dq.shift();)Zd.apply(null,eq);Rd.r=Zd};
var Rt=["div"],jC="onload",zx=!0,cB=!0,gg=function(a){return a},gC=null,Kg=function(a){var c=_.P(a);return"undefined"!==typeof c?c:_.P("gwidget/"+a)},gC=_.P(),ov,pv,Uj,En,Ft,It,Mt,Jt,St,tw,Ds,nq,uv,vv,Cv,Tt,sw,Ev,Ut,eC,fC,hC,Fv;_.P("gwidget");var jq=Kg("parsetags"),jC="explicit"===jq||"onload"===jq?jq:jC,lq=Kg("google_analytics");"undefined"!==typeof lq&&(zx=!!lq);var mq=Kg("data_layer");"undefined"!==typeof mq&&(cB=!!mq);ov=function(){var a=this&&this.Hh();a&&(_.bb.drw=a)};
...
socialTarget:h})}catch(v){}}a.call(this,f)}};_.qv=function(a,c,f,g,h){Tt(c,f);Ut(c,g);sw(a,c,h);XF(a.Fb,a.Kj.toString(),c);(new Ds).Vx.Ep(a,c,f,g,h)};Ds=function(){if(!this.Vx){for(var a=this.constructor;a&&!a.Ws;)a=a.T&&a.T.constructor;a.Ws.UD||(a.Ws.UD=Fk(a));this.Vx=new a.Ws.UD(this);this.G||(this.G=Nn)}};_.Gs=function(){};nq=Ds;_.Gs.T||_.J(_.Gs,Ak);nq.Ws=_.Gs;_.Gs.prototype.Ep=function(a){a=a?a:function(){};a.AE=!0;return a}();uv=function(a){return _.Rm&&a instanceof _.Rm};
...
_.iC=function(a){var c=Jt(a);hC(c);_.Sc(c.Fb,function(a){Fv(c,a)});Bd[c.Fb]=!0;var f={S:function(a,f,l){var n=f||{};n.type=c.Fb;f=n.type;delete n.type;var q=fv(a);if(q){a={};for(var t in n)_.Qa(n,t)&&(a[t.toLowerCase()]=n[t]);a.rd=1;(t=!!a.ri)&&delete a.ri;Hd(f,q,a,[],0,t,l)}else _.kd("string"==="gapi."+f+".render: missing element "+typeof a?a:"")},go:function(a){hv(a,c.Fb)},B:function(){var a=_.Ka(_.bb,"WI",_.r()),c;for(c in a)delete a[c]}};a=function(){"onload"===jC&&f.go()};$u(c.Fb)||_.rh(a,a); _.e("gapi."+c.Fb+".go",f.go);_.e("gapi."+c.Fb+".render",f.S);return f};
...
var Sv,Rv,Tv,ZM,Vv,Wv,Xv,Yv,Zv,hw,lw,mw,PZ,nw,Es,ow,pw,zv,vw,ww,yw,Fs,Iw,Jw,Kw,Mw,Nw,vE,Rw,MD,Pw,ND,Ow,Sw,rE,Tw,Uw,Vw,Ww,Zw,$w,ax,bx,cx,dx,ex,fx,ix,gx,jx,kx,lx,ox;_.fp.prototype.subscribe=_.d(34,function(a,c,f){var g=this.G[a];g||(g=this.G[a]=[]);var h=this.qa;this.B[h]=a;this.B[h+1]=c;this.B[h+2]=f;this.qa=h+3;g.push(h);return h});_.lH.prototype.subscribe=_.d(33,function(a,c,f){return this.B.subscribe(a.toString(),c,f)});
_.Bt=function(a,c,f,g){if(c=a.G[c]){var h=a.B;(c=_.ue(c,function(a){return h[a+1]==f&&h[a+2]==g}))&&a.zf(c)}};Sv=function(a){var c=Rv;_.Nk(c,[{Rr:"-webkit-transform",duration:1,timing:"ease",Le:0}]);_.Nk(c,[{Rr:"transform",duration:1,timing:"ease",Le:0}]);_.Rn(function(){c.style.webkitTransform="translate3d(0px,"+a+"px,0px)";c.style.transform="translate3d(0px,"+a+"px,0px)"},0)};
...
[c,"?parent=",(0,window.encodeURIComponent)(_.Rb.Pq(window.location.href)),"#rpctoken=",h,"&forcesecure=1"].join(""),f=_.R.Jk(),l=_.R.Fh({name:a,id:a});l.src=c;l.style.width="1px";l.style.height="1px";l.style.position="absolute";l.style.top="-100px";l.tabIndex="-1";f.appendChild(l);_.T.tf(a)}ND("oauth2relayReady",h,function(){vE()?MD.unregister("oauth2relayReady"):_.T.unregister("oauth2relayReady:"+h);var a=Pw;if(null!==a){Pw=null;for(var c=0,f=a.length;c<f;c++)a[c]()}});ND("oauth2callback",h,function(a){var c=
...
*/
_.In=function(a,c){this.Ka=[];this.Ei=a;this.zt=c||null;this.M=this.G=!1;this.ha=void 0;this.ye=this.te=this.Ld=!1;this.wc=0;this.B=null;this.qa=0};_.In.prototype.cancel=function(a){if(this.G)this.ha instanceof _.In&&this.ha.cancel();else{if(this.B){var c=this.B;delete this.B;a?c.cancel(a):(c.qa--,0>=c.qa&&c.cancel())}this.Ei?this.Ei.call(this.zt,this):this.ye=!0;this.G||this.bu(new _.nB)}};_.In.prototype.po=function(a,c){this.Ld=!1;Jn(this,a,c)};
var Jn=function(a,c,f){a.G=!0;a.ha=f;a.M=!c;Kn(a)},xB=function(a){if(a.G){if(!a.ye)throw new Mn;a.ye=!1}};_.k=_.In.prototype;_.k.Ga=function(a){xB(this);Jn(this,!0,a)};_.k.bu=function(a){xB(this);Jn(this,!1,a)};_.k.ea=function(a,c){return this.Ep(a,null,c)};_.k.Ep=function(a,c,f){this.Ka.push([a,c,f]);this.G&&Kn(this);return this};_.k.then=function(a,c,f){var g,h,l=new _.C(function(a,c){g=a;h=c});this.Ep(g,function(a){a instanceof _.nB?l.cancel():h(a)});return l.then(a,c,f)};_.Rp(_.In);
_.In.prototype.Kh=_.b(8);
var On=function(a){return(0,_.Ee)(a.Ka,function(a){return _.vd(a[1])})},Kn=function(a){if(a.wc&&a.G&&On(a)){var c=a.wc,f=yB[c];f&&(_.D.clearTimeout(f.El),delete yB[c]);a.wc=0}a.B&&(a.B.qa--,delete a.B);for(var c=a.ha,g=f=!1;a.Ka.length&&!a.Ld;){var h=a.Ka.shift(),l=h[0],n=h[1],h=h[2];if(l=a.M?n:l)try{var q=l.call(h||a.zt,c);_.kf(q)&&(a.M=a.M&&(q==c||q instanceof Error),a.ha=c=q);if(_.Wp(c)||"function"===typeof _.D.Promise&&c instanceof _.D.Promise)g=!0,a.Ld=!0}catch(t){c=t,a.M=!0,On(a)||(f=!0)}}a.ha=
c;g&&(q=(0,_.H)(a.po,a,!0),g=(0,_.H)(a.po,a,!1),c instanceof _.In?(c.Ep(q,g),c.te=!0):c.then(q,g));f&&(c=new zB(c),yB[c.El]=c,a.wc=c.El)},Mn=function(){_.se.call(this)};_.J(Mn,_.se);Mn.prototype.message="Deferred has already fired";Mn.prototype.name="AlreadyCalledError";_.nB=function(){_.se.call(this)};_.J(_.nB,_.se);_.nB.prototype.message="Deferred was canceled";_.nB.prototype.name="CanceledError";var zB=function(a){this.El=_.D.setTimeout((0,_.H)(this.G,this),0);this.B=a}; zB.prototype.G=function(){delete yB[this.El];throw this.B;};var yB={};

_.sA=function(a){if(!_.ea(a))for(var c=a.length-1;0<=c;c--)delete a[c];a.length=0};_.bi=function(a){_.dh.call(this);this.ye=a;this.ha={}};_.J(_.bi,_.dh);var ei=[];_.bi.prototype.N=function(a,c,f,g){return _.tr(this,a,c,f,g)};_.tr=function(a,c,f,g,h,l){_.ea(f)||(f&&(ei[0]=f.toString()),f=ei);for(var n=0;n<f.length;n++){var q=_.ph(c,f[n],g||a.handleEvent,h||!1,l||a.ye||a);if(!q)break;a.ha[q.key]=q}return a};
_.bi.prototype.cb=function(a,c,f,g,h){if(_.ea(c))for(var l=0;l<c.length;l++)this.cb(a,c[l],f,g,h);else f=f||this.handleEvent,h=h||this.ye||this,f=_.tl(f),g=!!g,c=_.wB(a)?_.ht(a.gc,String(c),f,g,h):a?(a=_.zt(a))?_.ht(a,c,f,g,h):null:null,c&&(_.Ch(c),delete this.ha[c.key]);return this};_.di=function(a){_.qf(a.ha,function(a,f){this.ha.hasOwnProperty(f)&&_.Ch(a)},a);a.ha={}};_.bi.prototype.C=function(){_.bi.T.C.call(this);_.di(this)};_.bi.prototype.handleEvent=function(){throw Error("v");};
...
jB=function(a,c){if(a)for(var f=a.split("&"),g=0;g<f.length;g++){var h=f[g].indexOf("="),l=null,n=null;0<=h?(l=f[g].substring(0,h),n=f[g].substring(h+1)):l=f[g];c(l,n?(0,window.decodeURIComponent)(n.replace(/\+/g," ")):"")}};bj=function(a){return _.ye.concat.apply(_.ye,arguments)};
_.cj=function(a,c){this.ha=this.Ka=this.G="";this.M=null;this.Kh=this.Ld="";this.qa=this.po=!1;var f;a instanceof _.cj?(this.qa=_.kf(c)?c:a.qa,_.KA(this,a.G),_.ZN(this,a.Ka),_.WP(this,a.ha),_.gj(this,a.M),this.setPath(a.getPath()),_.hj(this,a.B.clone()),this.wc(a.ye())):a&&(f=_.Vi(String(a)))?(this.qa=!!c,_.KA(this,f[1]||"",!0),_.ZN(this,f[2]||"",!0),_.WP(this,f[3]||"",!0),_.gj(this,f[4]),this.setPath(f[5]||"",!0),_.hj(this,f[6]||"",!0),this.wc(f[7]||"",!0)):(this.qa=!!c,this.B=new _.ij(null,0,this.qa))};
_.cj.prototype.toString=function(){var a=[],c=this.G;c&&a.push(lj(c,sj,!0),":");if(c=this.ha){a.push("//");var f=this.Ka;f&&a.push(lj(f,sj,!0),"@");a.push(_.fq(c).replace(/%25([0-9a-fA-F]{2})/g,"%$1"));c=this.M;null!=c&&a.push(":",String(c))}if(c=this.getPath())this.ha&&"/"!=c.charAt(0)&&a.push("/"),a.push(lj(c,"/"==c.charAt(0)?tj:uj,!0));(c=this.B.toString())&&a.push("?",c);(c=this.ye())&&a.push("#",lj(c,vj));return a.join("")};
_.cj.prototype.resolve=function(a){var c=this.clone(),f=!!a.G;f?_.KA(c,a.G):f=!!a.Ka;f?_.ZN(c,a.Ka):f=!!a.ha;f?_.WP(c,a.ha):f=null!=a.M;var g=a.getPath();if(f)_.gj(c,a.M);else if(f=!!a.Ld){if("/"!=g.charAt(0))if(this.ha&&!this.Ld)g="/"+g;else{var h=c.getPath().lastIndexOf("/");-1!=h&&(g=c.getPath().substr(0,h+1)+g)}h=g;if(".."==h||"."==h)g="";else if(-1!=h.indexOf("./")||-1!=h.indexOf("/.")){for(var g=_.jd(h,"/"),h=h.split("/"),l=[],n=0;n<h.length;){var q=h[n++];"."==q?g&&n==h.length&&l.push(""):
".."==q?((1<l.length||1==l.length&&""!=l[0])&&l.pop(),g&&n==h.length&&l.push("")):(l.push(q),g=!0)}g=l.join("/")}else g=h}f?c.setPath(g):f=""!==a.B.toString();f?_.hj(c,LA(a.B.toString())):f=!!a.Kh;f&&c.wc(a.ye());return c};_.cj.prototype.clone=function(){return new _.cj(this)};_.KA=function(a,c,f){_.GU(a);a.G=f?LA(c,!0):c;a.G&&(a.G=a.G.replace(/:$/,""));return a};_.ZN=function(a,c,f){_.GU(a);a.Ka=f?LA(c):c;return a};_.WP=function(a,c,f){_.GU(a);a.ha=f?LA(c,!0):c;return a};
_.gj=function(a,c){_.GU(a);if(c){c=Number(c);if((0,window.isNaN)(c)||0>c)throw Error("B`"+c);a.M=c}else a.M=null;return a};_.cj.prototype.getPath=function(){return this.Ld};_.cj.prototype.setPath=function(a,c){_.GU(this);this.Ld=c?LA(a,!0):a;return this};_.hj=function(a,c,f){_.GU(a);c instanceof _.ij?(a.B=c,kj(a.B,a.qa)):(f||(c=lj(c,mj)),a.B=new _.ij(c,0,a.qa));return a};_.cj.prototype.uj=function(a,c){return _.hj(this,a,c)};_.cj.prototype.Sj=function(){return this.B.toString()};
_.nj=function(a,c,f){_.GU(a);a.B.set(c,f);return a};_.cj.prototype.Mh=function(a){return this.B.get(a)};_.cj.prototype.ye=function(){return this.Kh};_.cj.prototype.wc=function(a,c){_.GU(this);this.Kh=c?LA(a):a;return this};_.GU=function(a){if(a.po)throw Error("C");};_.Kp=function(a){return a instanceof _.cj?a.clone():new _.cj(a,void 0)};LA=function(a,c){return a?c?(0,window.decodeURI)(a.replace(/%25/g,"%2525")):(0,window.decodeURIComponent)(a):""};
lj=function(a,c,f){return _.fa(a)?(a=(0,window.encodeURI)(a).replace(c,oj),f&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null};oj=function(a){a=a.charCodeAt(0);return"%"+(a>>4&15).toString(16)+(a&15).toString(16)};sj=/[#\/\?@]/g;uj=/[\#\?:]/g;tj=/[\#\?]/g;mj=/[\#\?@]/g;vj=/#/g;_.ij=function(a,c,f){this.G=this.B=null;this.ha=a||null;this.M=!!f};pj=function(a){a.B||(a.B=new _.Pi,a.G=0,a.ha&&jB(a.ha,function(c,f){a.add((0,window.decodeURIComponent)(c.replace(/\+/g," ")),f)}))};_.k=_.ij.prototype;
_.k.Da=function(){pj(this);return this.G};_.k.add=function(a,c){pj(this);this.ha=null;a=qj(this,a);var f=this.B.get(a);f||this.B.set(a,f=[]);f.push(c);this.G++;return this};_.k.remove=function(a){pj(this);a=qj(this,a);return _.Ri(this.B.G,a)?(this.ha=null,this.G-=this.B.get(a).length,this.B.remove(a)):!1};_.k.clear=function(){this.B=this.ha=null;this.G=0};_.k.isEmpty=function(){pj(this);return 0==this.G};var rj=function(a,c){pj(a);c=qj(a,c);return _.Ri(a.B.G,c)};_.k=_.ij.prototype;
_.k.zn=function(a){var c=this.Va();return _.ve(c,a)};_.k.$b=function(){pj(this);for(var a=this.B.Va(),c=this.B.$b(),f=[],g=0;g<c.length;g++)for(var h=a[g],l=0;l<h.length;l++)f.push(c[g]);return f};_.k.Va=function(a){pj(this);var c=[];if(_.fa(a))rj(this,a)&&(c=bj(c,this.B.get(qj(this,a))));else{a=this.B.Va();for(var f=0;f<a.length;f++)c=bj(c,a[f])}return c};_.k.set=function(a,c){pj(this);this.ha=null;a=qj(this,a);rj(this,a)&&(this.G-=this.B.get(a).length);this.B.set(a,[c]);this.G++;return this};
_.k.get=function(a,c){var f=a?this.Va(a):[];return 0<f.length?String(f[0]):c};_.Nr=function(a,c,f){a.remove(c);0<f.length&&(a.ha=null,a.B.set(qj(a,c),_.ze(f)),a.G+=f.length)};_.ij.prototype.toString=function(){if(this.ha)return this.ha;if(!this.B)return"";for(var a=[],c=this.B.$b(),f=0;f<c.length;f++)for(var g=c[f],h=_.fq(g),g=this.Va(g),l=0;l<g.length;l++){var n=h;""!==g[l]&&(n+="="+_.fq(g[l]));a.push(n)}return this.ha=a.join("&")};
_.ij.prototype.clone=function(){var a=new _.ij;a.ha=this.ha;this.B&&(a.B=this.B.clone(),a.G=this.G);return a};var qj=function(a,c){var f=String(c);a.M&&(f=f.toLowerCase());return f},kj=function(a,c){c&&!a.M&&(pj(a),a.ha=null,a.B.forEach(function(a,c){var h=c.toLowerCase();c!=h&&(this.remove(c),_.Nr(this,h,a))},a));a.M=c};_.ij.prototype.extend=function(a){for(var c=0;c<arguments.length;c++)_.Oi(arguments[c],function(a,c){this.add(c,a)},this)};

_.nu={s:function(a,c,f){return(0,window.isNaN)(f)||""==f||a.length>=f?a:a=-1<c.indexOf("-",0)?a+_.Gf(" ",f-a.length):_.Gf(" ",f-a.length)+a},f:function(a,c,f,g,h){g=a.toString();(0,window.isNaN)(h)||""==h||(g=(0,window.parseFloat)(a).toFixed(h));var l;l=0>a?"-":0<=c.indexOf("+")?"+":0<=c.indexOf(" ")?" ":"";0<=a&&(g=l+g);if((0,window.isNaN)(f)||g.length>=f)return g;g=(0,window.isNaN)(h)?Math.abs(a).toString():Math.abs(a).toFixed(h);a=f-g.length-l.length;return g=0<=c.indexOf("-",0)?l+g+_.Gf(" ",a): l+_.Gf(0<=c.indexOf("0",0)?"0":" ",a)+g},d:function(a,c,f,g,h,l,n,q){return _.nu.f((0,window.parseInt)(a,10),c,f,g,0,l,n,q)}};_.nu.i=_.nu.d;_.nu.u=_.nu.d;
...
"")||"/"),f=String(f||""));f||(f=_.P("googleapis.config/root"),c&&(f=_.P("googleapis.config/root-1p")||f),f=String(f||""));f=String(kY(c,f)||f);return a=_.ul(f,a)},zV=function(a,c,f,g){_.Yn.call(this);this.eg=a;this.Bd=c;this.Zb=f;this.Zc=g;this.wc=null};_.J(zV,_.Yn);
zV.prototype.then=function(a){this.wc||(this.wc=(new _.C(function(a,f){this.N("error",(0,_.H)(function(){f(AV(this))},this));this.N("success",(0,_.H)(function(){a(AV(this))},this));this.send(this.eg,this.Bd,this.Zb,this.Zc)},this)).then(function(a){a.headers=AU(a.headers);return a},function(a){return a.status?(a.headers=AU(a.headers),$H(a)):$H({result:DU,body:'{"error":{"code":-1,"message":"A network error occurred and the request could not be completed."}}',headers:null,status:null,statusText:null})}));
return this.wc.then.apply(this.wc,arguments)};
var AV=function(a){var c,f=a.getStatus(),g=_.KI(a);204==f?c=!1:c=""==a.Sk()?(0,_.of)(g):_.pA(a);for(var h={},l=a.getAllResponseHeaders().split("\r\n"),n=0;n<l.length;n++)if(!_.im(l[n])){var q=_.Cr(l[n],": ",2);h[q[0]]=h[q[0]]?h[q[0]]+(", "+q[1]):q[1]}var t;try{t=2<_.iB(a)?a.B.statusText:""}catch(v){t=""}return{result:c,body:g,headers:h,status:f,statusText:t}},yH=function(a,c){for(var f=_.re(c),g=f?c:arguments,f=f?0:1;f<g.length&&(a=a[g[f]],_.kf(a));f++);return a},cO=function(a){var c=a.params||_.r();
a=_.rf(c.headers)||{};var f=c.httpMethod||"GET",g=String(c.url||""),h=c.body||null,c=c.responseType||null,l=_.sE(a);delete a["X-Referer"];a=oG(a);a=new zV(g,f,h,a);a.fb=l;c&&(a.M=c);return a},BV=function(a,c){var f=a.params||_.r();f.url=f.path;var g=f.root,g=AY("/",_.sE(f.headers),g);g.match(/^(.*[^\/])?\/$/)&&(g=g.substr(0,g.length-1));f.root=g;a.params=f;_.Bk.Dd("makeHttpRequests",[a],c)},kC={"'":"\\'"},mC={"\x00":"\\0","\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t","\x0B":"\\x0B",'"':'\\"',
"\\":"\\\\"},yO=function(a,c){var f=function(a){a=_.rf(a);delete a.result;a={gapiRequest:{data:a}};c&&c(a,(0,_.mf)(a))};cO(a).then(f,f)},aG=function(a){return new _.C(function(c,f){var g=function(a){a&&a.gapiRequest?a=a.gapiRequest.data||a:f(a);a={result:204!=a.status&&(0,_.of)(a.body),body:a.body,headers:a.headers||null,status:a.status||null,statusText:a.statusText||null};_.Em(a.status)?c(a):f(a)};try{BV(a,g)}catch(h){f(h)}})},lP=function(a){var c;c=(a=yH(a,"params","headers"))&&_.Vg(a)?a:{};a="chrome-extension"==
(_.Vi(window.location.href)[1]||null);c=_.sE(c);var f=!0,g=_.Xn(_.fo);g&&_.kf(g.withCredentials)||(f=!1);return!(a&&c)&&f},wY=function(a){_.se.call(this,a)};_.J(wY,_.se);wY.prototype.name="gapi.client.Error";var iG=function(a,c){_.P("client/cors")&&lP(a)?yO(a,c):BV(a,c)},bG=function(a){if(!a||!_.vd(a))throw new wY("Must provide a function.");this.ha=null;this.M=a};bG.prototype.then=function(a,c,f){this.ha||(this.ha=this.M());return this.ha.then(a,c,f)};
bG.prototype.vR=function(a){this.ha||(this.ha=a)};
var rC=function(a){(0,window.isFinite)(a)&&(a=String(a));return _.fa(a)?/^\s*-?0x/i.test(a)?(0,window.parseInt)(a,16):(0,window.parseInt)(a,10):window.NaN},sC=function(a){a=String(a);if(a.quote)return a.quote();for(var c=['"'],f=0;f<a.length;f++){var g=a.charAt(f),h=g.charCodeAt(0),l=f+1,n;if(!(n=mC[g])){if(!(31<h&&127>h))if(g in kC)g=kC[g];else if(g in mC)g=kC[g]=mC[g];else{h=g;n=g.charCodeAt(0);if(31<n&&127>n)h=g;else{if(256>n){if(h="\\x",16>n||256<n)h+="0"}else h="\\u",4096>n&&(h+="0");h+=n.toString(16).toUpperCase()}g= kC[g]=h}n=g}c[l]=n}c.push('"');return c.join("")};
var DC=function(a){this.B={};for(var c=0;c<a.length;c++){var f=a[c];this.B[f.B]=f}},EC=function(a){a=_.Li(a.B);_.kB(a,function(a,f){return a.B-f.B});return a};var TC=function(a,c){this.B=a;this.M=c.name;this.ha=!!c.TP;this.G=c.ua;this.qa=c.type};var jI=function(){this.Nl={};this.G=this.bh().B;this.B=null},VC=function(a,c,f){f=f||a;for(var g in a.Nl){var h=Number(g);a.G[h]||c.call(f,h,a.Nl[g])}};_.k=jI.prototype;_.k.has=function(a){return null!=this.Nl[a.B]};_.k.get=function(a,c){var f=a.B,g=lD(this,f);return this.G[f].ha?g[c||0]:g};_.k.set=function(a,c){dD(this,a.B,c)};_.k.add=function(a,c){nv(this,a.B,c)};_.k.clear=function(a){a=a.B;delete this.Nl[a];this.B&&delete this.B[a]};
_.k.equals=function(a){if(!a||this.constructor!=a.constructor)return!1;for(var c=EC(this.bh()),f=0;f<c.length;f++){var g=c[f],h=g.B;if(null!=this.Nl[h]!=(null!=a.Nl[h]))return!1;if(null!=this.Nl[h]){var l=11==g.G||10==g.G,n=lD(this,h),h=lD(a,h);if(g.ha){if(n.length!=h.length)return!1;for(g=0;g<n.length;g++){var q=n[g],t=h[g];if(l?!q.equals(t):q!=t)return!1}}else if(l?!n.equals(h):n!=h)return!1}}return!0};
var DD=function(a,c){for(var f=EC(a.bh()),g=0;g<f.length;g++){var h=f[g],l=h.B;if(null!=c.Nl[l]){a.B&&delete a.B[h.B];var n=11==h.G||10==h.G;if(h.ha)for(var h=lD(c,l)||[],q=0;q<h.length;q++)nv(a,l,n?h[q].clone():h[q]);else h=lD(c,l),n?(n=lD(a,l))?DD(n,h):dD(a,l,h.clone()):dD(a,l,h)}}};jI.prototype.clone=function(){var a=new this.constructor;a!=this&&(a.Nl={},a.B&&(a.B={}),DD(a,this));return a};
var lD=function(a,c){var f=a.Nl[c];return null==f?null:f},dD=function(a,c,f){a.Nl[c]=f;a.B&&(a.B[c]=f)},nv=function(a,c,f){a.Nl[c]||(a.Nl[c]=[]);a.Nl[c].push(f);a.B&&delete a.B[c]},zE=function(a){var c=[],f;for(f in a)0!=f&&c.push(new TC(f,a[f]));return new DC(c)};
var OD=function(){jI.call(this)},CE;_.J(OD,jI);var TD=function(){jI.call(this)},GE;_.J(TD,jI);OD.prototype.bh=function(){CE||(CE=zE({0:{name:"Version",Nf:"buzz.channel.Version"},1:{name:"major_version",ua:5,type:Number},2:{name:"minor_version",ua:5,type:Number}}));return CE};OD.ctor=OD;OD.ctor.bh=OD.prototype.bh;TD.prototype.bh=function(){GE||(GE=zE({0:{name:"ProtocolVersion",Nf:"buzz.channel.ProtocolVersion"},1:{name:"version",ua:11,type:OD}}));return GE};TD.ctor=TD;TD.ctor.bh=TD.prototype.bh;
...
var KP=new TD,VP=new OD;dD(VP,1,3);dD(VP,2,2);dD(KP,1,VP);var dT=new OD;dD(dT,1,3);dD(dT,2,2);var uU=new OD;dD(uU,1,3);dD(uU,2,2);var DE=function(){};var IE=function(a,c){this.B=!!c};_.J(IE,DE);
var LE=function(a,c,f){var g=EC(c.bh());(0,_.Be)(g,function(a){if(c.has(a)){var g;g=a.B;g=c.G[g].ha?null!=c.Nl[g]?c.Nl[g].length:0:null!=c.Nl[g]?1:0;for(var n=0;n<g;++n){f.append(a.M);11==a.G||10==a.G?(f.append(" {"),ME(f),f.B+=2):f.append(": ");NE(this,c.get(a,n),a,f);if(11==a.G||10==a.G)f.B-=2,f.append("}");ME(f)}}},a);VC(c,function(a,c){OE(this,a,c,f)},a)},OE=function(a,c,f,g){if(null!=f)if(_.ea(f))(0,_.Be)(f,function(a){OE(this,c,a,g)},a);else{if(_.Vg(f)){g.append(c);g.append(" {");ME(g);g.B+=
2;if(f instanceof jI)LE(a,f,g);else for(var h in f){var l=rC(h);OE(a,l,f[h],g)}g.B-=2;g.append("}")}else _.fa(f)&&(f=sC(f)),g.append(c),g.append(": "),g.append(f.toString());ME(g)}},NE=function(a,c,f,g){switch(f.G){case 1:case 2:case 3:case 4:case 5:case 13:case 6:case 7:case 8:case 15:case 16:case 17:case 18:g.append(c);break;case 12:case 9:c=sC(c.toString());g.append(c);break;case 14:if(!a.B){var h=!1;_.qf(f.qa,function(a,f){a==c&&(g.append(f),h=!0)})}h&&!a.B||g.append(c.toString());break;case 10:case 11:LE(a,
c,g)}},KE=function(){this.B=0;this.G=[];this.ha=!0};KE.prototype.toString=function(){return this.G.join("")};KE.prototype.append=function(a){if(this.ha){for(var c=0;c<this.B;++c)this.G.push(" ");this.ha=!1}this.G.push(a.toString())};var ME=function(a){a.G.push("\n");a.ha=!0};
var hF=new IE;jI.prototype.toString=function(){var a=new KE;LE(hF,this,a);return a.toString()};new _.Gn([1,2,3]);new _.Gn([1,2]);new _.Hh;var R_=function(){for(var a=10,c=Q_,f=c.length,g="";0<a--;)g+=c.charAt(Math.floor(Math.random()*f));return g},Q_="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";var DF=function(a){_.dh.call(this);this.eb=a||_.xf()};_.J(DF,_.dh);DF.prototype.zF=0;DF.prototype.O=function(){return this.zF};DF.prototype.Aa=function(){return this.eb.Aa()};var EF=function(a,c){DF.call(this,c);this.B=a;this.Ld=this.B.G().ppu;this.Kb=this.B.G().lpu;this.Ka=[]},FF,sG;_.J(EF,DF);_.k=EF.prototype;_.k.sQ=5;_.k.zF=4;_.k.zD=0;_.k.CF=!1;_.k.fo=!1;_.k.iQ=null;var tG=function(a){return"googlexpc_"+a.B.name+"_msg"},QG=function(a){return"googlexpc_"+a.B.name+"_ack"},bH=function(a){try{if(!a.Ma()&&a.B.M())return a.B.Ka().frames||{}}catch(c){}return{}};
EF.prototype.connect=function(){if(!this.Ma()&&this.B.M()){if(!this.fo){var a=tG(this);this.ha=cH(this,a);this.ye=this.Aa().frames[a];a=QG(this);this.G=cH(this,a);this.wc=this.Aa().frames[a];this.fo=!0}if(dH(this,tG(this))&&dH(this,QG(this)))this.te=new eH(this,bH(this)[tG(this)],(0,_.H)(this.fb,this)),this.po=new eH(this,bH(this)[QG(this)],(0,_.H)(this.Za,this)),this.Ei();else{if(1==this.B.ha())this.iQ||0<this.sQ--||(this.B.ye(R_()),fH(this),this.fo=!1,this.iQ=cH(this,"googlexpc_reconnect_"+this.B.name));
else if(0==this.B.ha())for(var a=bH(this),c=a.length,f=0;f<c;f++){var g;try{a[f]&&a[f].name&&(g=a[f].name)}catch(h){}if(g){var l=g.split("_");if(3==l.length&&"googlexpc"==l[0]&&"reconnect"==l[1]){this.B.name=l[2];fH(this);this.fo=!1;break}}}this.Aa().setTimeout((0,_.H)(this.connect,this),100)}}};
var cH=function(a,c){var f=window.document.createElement("IFRAME"),g=f.style;g.position="absolute";g.top="-10px";g.left="10px";g.width="1px";g.height="1px";f.id=f.name=c;f.src=a.Ld+"#INITIAL";a.Aa().document.body.appendChild(f);return f},fH=function(a){a.ha&&(a.ha.parentNode.removeChild(a.ha),a.ha=null,a.ye=null);a.G&&(a.G.parentNode.removeChild(a.G),a.G=null,a.wc=null)},dH=function(a,c){try{var f=bH(a)[c];if(!f||0!=f.location.href.indexOf(a.Kb))return!1}catch(g){return!1}return!0};
EF.prototype.Ei=function(){var a=bH(this);a[QG(this)]&&a[tG(this)]?(this.ca=new gH(this.Ld,this.ye),this.qa=new gH(this.Ld,this.wc),this.Aa().setTimeout((0,_.H)(function(){this.ca.send("SETUP");this.CF=!0},this),100)):(this.zt||(this.zt=(0,_.H)(this.Ei,this)),this.Aa().setTimeout(this.zt,100))};var hH=function(a){if(a.Na&&a.Zb&&(a.B.wc(),a.M)){for(var c=0,f;c<a.M.length;c++)f=a.M[c],a.B.qa(f.service,f.rQ);delete a.M}};
EF.prototype.fb=function(a){if("SETUP"==a)this.qa&&(this.qa.send("SETUP_ACK"),this.Na=!0,hH(this));else if(this.B.B()||this.Na){var c=a.indexOf("|"),f=a.substring(0,c);a=a.substring(c+1);c=f.indexOf(",");if(-1==c){var g;this.qa.send("ACK:"+f);iH(this,a)}else g=f.substring(0,c),this.qa.send("ACK:"+g),f=f.substring(c+1).split("/"),c=(0,window.parseInt)(f[0],10),f=(0,window.parseInt)(f[1],10),1==c&&(this.Kh=[]),this.Kh.push(a),c==f&&(iH(this,this.Kh.join("")),delete this.Kh)}};
EF.prototype.Za=function(a){"SETUP_ACK"==a?(this.CF=!1,this.Zb=!0,hH(this)):this.B.B()&&this.CF&&(0,window.parseInt)(a.split(":")[1],10)==this.zD&&(this.CF=!1,jH(this))};var jH=function(a){if(!a.CF&&a.Ka.length){var c=a.Ka.shift();++a.zD;a.ca.send(a.zD+c);a.CF=!0}},iH=function(a,c){var f=c.indexOf(":"),g=c.substr(0,f),f=c.substring(f+1);a.B.B()?a.B.qa(g,f):(a.M||(a.M=[])).push({service:g,rQ:f})};
EF.prototype.send=function(a,c){var f=a+":"+c;if(!_.W||3800>=c.length)this.Ka.push("|"+f);else for(var g=c.length,h=Math.ceil(g/3800),l=0,n=1;l<g;)this.Ka.push(","+n+"/"+h+"|"+f.substr(l,3800)),n++,l+=3800;jH(this)};EF.prototype.C=function(){EF.T.C.call(this);var a=GF;_.xe(a,this.te);_.xe(a,this.po);this.te=this.po=null;_.Tf(this.ha);_.Tf(this.G);this.ye=this.wc=this.ha=this.G=null};
var GF=[],HF=(0,_.H)(function(){var a=GF,c,f=!1;try{for(var g=0;c=a[g];g++)f=f||c.ym()}catch(h){if(c.M.B.Ld(),!a.length)return}a=(0,_.pa)();f&&(FF=a);sG=window.setTimeout(HF,1E3>a-FF?10:100)},EF),kH=function(){FF=(0,_.pa)();sG&&window.clearTimeout(sG);sG=window.setTimeout(HF,10)},gH=function(a,c){this.ha=a;this.G=c;this.B=0};gH.prototype.send=function(a){this.B=++this.B%2;a=this.ha+"#"+this.B+(0,window.encodeURIComponent)(a);try{_.ef?this.G.location.href=a:this.G.location.replace(a)}catch(c){}kH()};
var eH=function(a,c,f){this.M=a;this.G=c;this.ha=f;this.B=this.G.location.href.split("#")[0]+"#INITIAL";GF.push(this);kH()};eH.prototype.ym=function(){var a=this.G.location.href;if(a!=this.B){this.B=a;if(a=a.split("#")[1])a=a.substr(1),this.ha((0,window.decodeURIComponent)(a));return!0}return!1};
var CX=function(a){this.ha=a;this.M=!1;this.promise={then:(0,_.H)(function(a,f,g){this.M||(this.M=!0);this.G&&!this.B?this.ha.resolve(this.G):this.B&&!this.G&&this.ha.reject(this.B);return this.ha.promise.then(a,f,g)},this)}};CX.prototype.resolve=function(a){this.M?this.ha.resolve(a):this.G||this.B||(this.G=a)};CX.prototype.reject=function(a){this.M?this.ha.reject(a):this.G||this.B||(this.B=a)};
var BH=function(a){bG.call(this,BH.prototype.qa);if(!a||"object"!=typeof a&&"string"!=typeof a)throw new wY("Invalid request parameters");var c;_.fa(a)?c={path:a}:c=a;if(!c.path)throw new wY('Missing required parameter: "path"');this.B={path:c.path,method:c.method||"GET",params:c.params||{},headers:c.headers||{},body:c.body,root:c.root,responseType:c.responseType};this.G=c.authType||"auto"};_.J(BH,bG);BH.prototype.eR=function(){return this.B};
BH.prototype.fR=function(){var a=this.B,c=a.headers||{},f=c,g=a.applicationName||null,h=a.clientName||null,l=a.clientVersion||null,l=l||"0.1",h=h||"google-api-javascript-client",n=[];g&&(n.push(g),n.push(" "));n.push(h);l&&(n.push("/"),n.push(l));f["X-JavaScript-User-Agent"]=n.join("");f=c["Content-Type"];a.body&&!f&&(f="application/json",c["Content-Type"]=f);"application/json"!=f||a.params.alt||(a.params.alt="json");(f=a.body||null)&&_.Vg(f)&&(a.body=(0,_.mf)(f));a.key=a.id;c=_.Bk.Md(c,void 0,this.G);
...
1)&&(h+="/");g=_.ul(h,g);_.jr(g,"/")&&(g=g.substring(0,g.length-1));g=_.Zi(_.aj([g],c));a.path=g;a.root=kY(f,a.root);a.url=AY(a.path,f,a.root)};var Km=function(a){a.fR();a=a.B;return{key:"gapiRequest",params:{id:a.id,key:a.key,url:a.url,path:a.path,httpMethod:a.method,body:a.body||"",headers:a.headers||{},urlParams:{},root:a.root,clientName:Am(),clientVersion:Cm()}}};
BH.prototype.execute=function(a){this.B.headers.Authorization||_.kk(void 0,void 0);var c=Km(this);iG(c,function(c,g){var h=c;c.gapiRequest&&(h=c.gapiRequest);h&&h.data&&(h=h.data);var h=h instanceof Array?h[0]:h,l;if(204!=h.status&&h.body)try{l=(0,_.of)(h.body)}catch(n){}_.P("client/jsonpOverride")&&(l=h);a&&a(l,g)})};BH.prototype.qa=function(){var a=Km(this);return _.P("client/cors")&&lP(a)?cO(a):aG(a)};
...
var gG=function(a){bG.call(this,gG.prototype.qa);this.B=[];this.G=a;this.Ka=!!a};_.J(gG,bG);var $F=function(a,c){for(var f=0;f<a.B.length;f++)if(a.B[f].id==c)return!0;return!1};
gG.prototype.add=function(a,c){var f=c||_.r(),g=_.r();if(a)g.request=a;else throw new wY("Batch entry "+(_.Qa(f,"id")?'"'+f.id+'" ':"")+"is missing a request method");var h;h=_.Su();h=new CX(h);g.Ae=h;a.vR(g.Ae.promise);h=a.eR().root;if(!this.Ka){if(h&&this.G&&h!=this.G)throw new wY('The "root" provided in this request is not consistent with that of existing requests in the batch.');this.G=h||this.G}if(_.Qa(f,"id")){h=f.id;if($F(this,h))throw new wY('Batch ID "'+h+'" already in use, please use another.');
g.id=h}else{do g.id=String(Math.round(2147483647*(0,_.Vb)()));while($F(this,g.id))}g.Ga=f.callback;this.B.push(g);return g.id};gG.prototype.execute=function(a){1>this.B.length||(_.eb(this.B,function(a){a.request.fR()}),a=hG(this,a),MG(this.B,this.G).execute(a))};
gG.prototype.qa=function(){if(1>this.B.length)return new _.C(function(a){a({})});_.eb(this.B,function(a){a.request.fR()});var a=MG(this.B,this.G),c=(0,_.H)(function(a){sH(a);if(0!=wH(a.headers,"Content-Type").indexOf("multipart/mixed"))throw new wY("The response's Content-Type is not multipart/mixed.");var c=wH(a.headers,"Content-Type").split("boundary=")[1];if(!c)throw new wY("Boundary not indicated in response.");c=zH(a.body,"--"+c);a.result=c||{};for(var f=0;f<this.B.length;f++){var n=this.B[f],
q=c[n.id];_.Em(q.status)?n.Ae.resolve(q):n.Ae.reject(q)}return a},this),f=(0,_.H)(function(a){for(var c=0;c<this.B.length;c++)this.B[c].Ae.reject({result:{error:{code:0,message:"The batch request could not be fulfilled."}},body:'{"error":{"code":0,"message":"The batch request could not befulfilled"}}',headers:null,status:null,statusText:null});throw a;},this);return a.then(c,f)};
var hG=function(a,c){return(0,_.H)(function(a,g){var h;h=a;if(g&&!h){var l=(0,_.of)(g);l&&(l.gapiRequest?h=l.gapiRequest.data:h=l)}sH(h);if(h){if(0!=wH(h.headers,"Content-Type").indexOf("multipart/mixed"))throw new wY("The response's Content-Type is not multipart/mixed.");if(200<=h.status&&299>=h.status){var n=wH(h.headers,"Content-Type").split("boundary=")[1];if(!n)throw new wY("Boundary not indicated in response.");n=AH(h.body,"--"+n);for(h=0;h<this.B.length;h++)if(l=this.B[h],delete n[l.id].rawResult, l.Ga){var q=(0,_.mf)(n[l.id]);l.Ga(n[l.id]||!1,q)}}c&&c(n||null,g)}},a)},sH=function(a){if(a&&a.headers){var c=_.r(),f;for(f in a.headers)c[f.toLowerCase()]=a.headers[f];a.headers=c}};
var MF=["appVersion","platform","userAgent"],Bm={"google-api-javascript-client":!0,"google-api-gwt-client":!0},Im={},xm=function(a,c){var f;return f="/discovery/v1/apis/"+((0,window.encodeURIComponent)(a)+"/"+(0,window.encodeURIComponent)(c)+"/rpc?fields=methods%2F*%2Fid&pp=0")},NF=function(a,c){var f;return f="/discovery/v1/apis/"+((0,window.encodeURIComponent)(a)+"/"+(0,window.encodeURIComponent)(c)+"/rest?fields=rootUrl%2CservicePath%2Cresources%2Cparameters%2Cmethods&pp=0")},ym=function(a){if(a&&
window.navigator){for(var c=[],f=0;f<MF.length;f++){var g=window.navigator[MF[f]];g&&c.push((0,window.encodeURIComponent)(MF[f])+"="+(0,window.encodeURIComponent)(g))}a["X-ClientDetails"]=c.join("&")}},Am=function(){var a=_.P("client/name","google-api-javascript-client");return a in Bm?a:"google-api-javascript-client"},Cm=function(){return String(_.P("client/version","1.1.0-beta"))},OF=function(a,c,f,g){if(!a||!c)throw new wY("Missing required parameters.");var h=f||function(){};Dm({path:xm(a,c),
callback:function(a){if(a.error)h(a);else{var f=null!=a.rootUrl?String(a.rootUrl):g,f=_.fa(f)?f.replace(/([^\/])\/$/,"$1"):void 0,q;for(q in a)if(a.hasOwnProperty(q)&&"methods"==q){var t=a[q],v;for(v in t)if(t.hasOwnProperty(v)){SF(v,{root:f},void 0);var w={};w[v]=c;Hm(w)}}h.call(null)}},root:g})},QF=function(a,c,f,g){function h(a){function c(a){_.fb(a,function(a){PF(n,a,I,h)})}function f(a){_.fb(a,function(a){c(a.methods);(a=a.resources)&&f(a)})}if(a.error)q(a);else{var h=_.rf(_.Vg(g)?g:{}),l=h.root,
l=null!=a.rootUrl?String(a.rootUrl):l,l=_.fa(l)?l.replace(/([^\/])\/$/,"$1"):void 0;h.root=l;var n=a.servicePath,I=a.parameters;(l=a.resources)&&f(l);(a=a.methods)&&c(a);q.call()}}var l,n;_.Vg(a)?(n=a,l=a.name,c=a.version):l=a;if(!l||!c)throw new wY("Missing required parameters.");var q=f||function(){};n?h(n):Dm({path:NF(l,c),callback:h,root:g&&g.root})},Dm=function(a,c){var f;"object"==typeof a&&(f=a.callback,delete a.callback);var g;KW()?g=new kX(a,c):g=new BH(a);return f?(g.execute(f),null):g},
RF=function(a,c){c=_.rf(c);var f=function(a,c,f){var g;if(a.hasOwnProperty(c))g=a[c],delete a[c];else if(f)throw new wY("Missing required parameters.");return g},g=f(c,"servicePath",!0),h=String(f(c,"restPath",!0)),l=String(f(c,"httpMethod",!0)),n=f(c,"parameters");null!=n?n=_.rf(n):n=null;var q=f(c,"parameterName");_.fa(q)||(q=null);f=f(c,"supportsSubscription");if(!h||!l)throw new wY("Missing required parameters.");h={id:a,path:h,parameters:n,httpMethod:l,request:{parameterName:q}};f&&(h.supportsSubscription=
f);PF(g,h,{path:{},query:{}},c)},SF=function(a,c,f){if(!a)throw new wY("Missing required parameters");for(var g=a.split("."),h=window.gapi.client,l=0;l<g.length-1;l++){var n=g[l];h[n]=h[n]||{};h=h[n]}g=g[g.length-1];if(!h[g]||f){var q=c||{};h[g]=function(c){var f;"string"==typeof q?f=q:f=q.root;c&&c.root&&(f=c.root);c={method:a,apiVersion:q.apiVersion,rpcParams:c,transport:{name:"googleapis",root:f}};return KW()?new kX(c,2):new Gm(c)}}},PF=function(a,c,f,g){if(!(c&&c.id&&c.path&&c.httpMethod))throw new wY("Missing required parameters");
var h=c.id.split("."),l=window.gapi.client,n;for(n=0;n<h.length-1;n++){var q=h[n];l[q]=l[q]||{};l=l[q]}q=window.gapi.client[h[0]];q.kB||(q.kB={servicePath:a||"",parameters:f});a=h[n];if(!l[a]){if(g&&g.hasOwnProperty("root"))var t=g.root;l[a]=_.ma(lX,{path:_.fa(c.path)?c.path:null,httpMethod:_.fa(c.httpMethod)?c.httpMethod:null,parameters:c.parameters,parameterName:(c.request||{}).parameterName||"",request:c.request,root:t},q.kB)}},lX=function(a,c,f,g){var h=c.servicePath||"";_.jd(h,"/")||(h="/"+h);
f=WF(a.path,[a.parameters,c.parameters],f||{});c=f.pe;var l=f.hM,h=_.ul(h,f.path);f=l.root;delete l.root;var n=a.parameterName;!n&&1==_.qA(l)&&l.hasOwnProperty("resource")&&(n="resource");var q;n&&(q=l[n],delete l[n]);null!=q||(q=g);null==q&&a.request&&(_.Og(l)&&(l=void 0),q=l);g="complete"==_.P("client/rms")?0:1;l={};n=a.httpMethod;"GET"==n&&_.kf(q)&&""!=String(q)&&(l["X-HTTP-Method-Override"]=n,n="POST");return Dm({path:h,method:n,params:c,headers:l,body:q,root:f||a.root},g)||null},WF=function(a,
c,f){f=_.rf(f);var g={};_.eb(c,function(c){_.fb(c,function(c,h){var q=c.required;if("path"==c.location)if(Object.prototype.hasOwnProperty.call(f,h))-1!=a.indexOf("{"+h+"}")?(q=_.fq(f[h]),a=a.replace("{"+h+"}",q)):-1!=a.indexOf("{+"+h+"}")&&(q=(0,window.encodeURI)(String(f[h])),a=a.replace("{+"+h+"}",q)),delete f[h];else{if(q)throw new wY("Required path parameter "+h+" is missing.");}else"query"==c.location&&Object.prototype.hasOwnProperty.call(f,h)&&(g[h]=f[h],delete f[h])})});if(c=f.trace)g.trace=
c,delete f.trace;return{path:a,pe:g,hM:f}},YF=function(a){return KW()?new mX(a,0):new gG(a)},Hm=function(a){_.em(a);for(var c in a)Object.prototype.hasOwnProperty.call(a,c)&&(Im[c]=a[c])};_.gm(null);var ZF=function(a){var c=["complete"],f=_.P("client/rms");if(_.ve(["rpcDeprecated","migrated"],f))_.kd(a+" is deprecated. See https://developers.google.com/api-client-library/javascript/reference/referencedocs");else if(_.ve(c,f))throw new wY(a+" is discontinued.");},KW=function(){return"migrated"==_.P("client/rms")};
var Lm=function(){this.B=[];this.ha=this.G=null};Lm.prototype.add=function(a,c){var f=c||{},g={},h=Object.prototype.hasOwnProperty;if(a)g.qf=a;else throw new wY("Batch entry "+(h.call(f,"id")?'"'+f.id+'" ':"")+"is missing a request method");if(h.call(f,"id")){for(var h=f.id,l=0;l<this.B.length;l++)if(this.B[l].id==h)throw new wY('Batch ID "'+h+'" already in use, please use another.');g.id=h}else{do g.id=String(2147483647*(0,_.Vb)()|0);while(h.call(this.B,g.id))}g.Ga=f.callback;this.B.push(g)};
Lm.prototype.execute=function(a){this.G=[];for(var c,f,g=0;g<this.B.length;g++)c=this.B[g],f=c.qf,this.G.push(f.Vs(c.id)),this.ha=f.Ns()||this.ha;c={};c=_.Bk.Md(c);ym(c);c={requests:this.G,headers:c,root:this.ha,clientName:Am(),clientVersion:Cm(),urlParams:{key:_.jm.key}};_.Bk.Dd("makeRequest",c,Mm(this,a))};var Mm=function(a,c){return function(f,g){for(var h=0;h<a.B.length;h++){var l=a.B[h];l.Ga&&l.Ga(f[l.id]||!1,g)}c&&c(f,g)}};
var Gm=function(a){if(!a||"object"!=typeof a)throw new wY("Missing rpc parameters");if(!a.method)throw new wY("Missing rpc method");this.B=a};Gm.prototype.Ns=function(){var a=this.B.transport;return a?a.root||null:null};Gm.prototype.execute=function(a){var c=new Lm;c.add(this,{id:"gapiRpc",callback:Om(a)});c.execute()};Gm.prototype.Vs=function(a){var c=this.B.method;a={jsonrpc:"2.0",id:a,method:c,apiVersion:String(this.B.apiVersion||Im[c]||"v1")};(c=this.B.rpcParams)&&(a.params=c);return a}; var Om=function(a){return function(c,f){var g;c?c.error?(g=c.error,null==g.error&&(g.error=_.rf(c.error))):(g=c.result||c.data,_.Vg(g)&&null==g.result&&(g.result=_.rf(c.result||c.data))):g=!1;a(g,f)}};
var kX=function(a,c){this.G=c||0;if(2==this.G){var f=null;null!=a&&_.Vg(a)&&(f={method:a.method,rpcParams:a.rpcParams,transport:a.transport,root:a.root,apiVersion:a.apiVersion,authType:a.authType});this.B=new Gm(f)}else 0==this.G&&(f=a&&a.callback)&&(a.callback=oX(f)),f=null,null!=a&&(_.Vg(a)?f={path:a.path,method:a.method,params:a.params,headers:a.headers,body:a.body,root:a.root,responseType:a.responseType,authType:a.authType}:_.fa(a)&&(f=a)),this.B=new BH(f)},oX=function(a){return function(c){var f;
null!=c&&_.Vg(c)&&c.error?(f=oF(c),c=(0,_.mf)([{id:"gapiRpc",error:f}]),f.error=_.TO(f)):(null!=c||(c={}),f=_.TO(c),f.result=_.TO(c),c=(0,_.mf)([{id:"gapiRpc",result:c}]));a(f,c)}},oF=function(a){a=_.TO(a.error);return{code:a.code,data:a.errors,message:a.message}};_.k=kX.prototype;_.k.execute=function(a){var c;a&&1==this.G?c=oX(a):c=a;this.B.execute(c)};_.k.then=function(a,c,f){2==this.G&&pX('The "then" method is not available on this object.');return this.B.then(a,c,f)};
_.k.vR=function(a){this.B.vR&&this.B.vR(a)};_.k.eR=function(){if(this.B.eR)return this.B.eR()};_.k.fR=function(){this.B.eR&&this.B.fR()};_.k.Ns=function(){if(this.B.Ns)return this.B.Ns()};_.k.Vs=function(a){if(this.B.Vs)return this.B.Vs(a)};var mX=function(a,c){this.ha=a;this.B=c||null;this.G=null};
mX.prototype.add=function(a,c){null===this.B&&(this.B=a.G,2==this.B?this.G=new Lm:this.G=new gG(this.ha));this.B!==a.G&&pX("Unable to add item to batch.");var f=c&&c.callback;1==this.B&&f&&(c.callback=function(a){a=zF(a);var c=(0,_.mf)([a]);f(a,c)});this.G.add(a,c)};mX.prototype.execute=function(a){var c;a&&1==this.B?c=function(c){var g=[];_.fb(c,function(a,h){a=zF(a);c[h]=a;g.push(a)});var h=(0,_.mf)(g);a(c,h)}:c=a;this.G&&this.G.execute(c)};
var zF=function(a){var c=a?yH(a,"result"):null;_.Vg(c)&&null!=c.error&&(c=oF(c),a={id:a.id,error:c});return a};mX.prototype.then=function(a,c,f){2==this.B&&pX('The "then" method is not available on this object.');return this.G.then(a,c,f)};var pX=function(a){throw Error("N`"+a);};
